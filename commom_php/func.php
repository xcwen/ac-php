...
/** @return string */
function apache_getenv(string $variable,bool $walk_to_top){}
/** @return array */
...
/** @return bool */
function apc_add(string $key,mixed $var,int $ttl){}
/** @return int */
function apc_bin_dumpfile(array $files,array $user_vars,string $filename,int $flags,resource $context){}
/** @return string */
function apc_bin_dump(array $files,array $user_vars){}
/** @return bool */
function apc_bin_load(string $data,int $flags){}
/** @return bool */
function apc_bin_loadfile(string $filename,resource $context,int $flags){}
/** @return array */
function apc_cache_info(string $cache_type,bool $limited){}
/** @return bool */
function apc_cas(string $key,int $old,int $new){}
/** @return bool */
function apc_clear_cache(string $cache_type){}
/** @return mixed */
function apc_compile_file(string $filename,bool $atomic){}
/** @return int */
function apc_dec(string $key,int $step,bool &$success){}
/** @return bool */
function apc_define_constants(string $key,array $constants,bool $case_sensitive){}
/** @return mixed */
...
/** @return int */
function apc_inc(string $key,int $step,bool &$success){}
/** @return bool */
function apc_load_constants(string $key,bool $case_sensitive){}
/** @return array */
function apc_sma_info(bool $limited){}
/** @return bool */
function apc_store(string $key,mixed $var,int $ttl){}
/** @return bool */
function apd_breakpoint(int $debug_level){}
/** @return array */
function apd_callstack(){}
/** @return void */
function apd_clunk(string $warning,string $delimiter){}
/** @return bool */
function apd_continue(int $debug_level){}
/** @return void */
function apd_croak(string $warning,string $delimiter){}
/** @return void */
...
/** @return string */
function apd_set_pprof_trace(string $dump_directory,string $fragment){}
/** @return bool */
function apd_set_session_trace_socket(string $tcp_server,int $socket_type,int $port,int $debug_level){}
/** @return void */
function apd_set_session_trace(int $debug_level,string $dump_directory){}
/** @return void */
function apd_set_session(int $debug_level){}
/** @return array */
//function array(mixed $args ){}
/** @return array */
function array_change_key_case(array $input,int $case){}
/** @return array */
function array_chunk(array $input,int $size,bool $preserve_keys){}
/** @return array */
function array_column(array $input,mixed $column_key,mixed $index_key){}
/** @return array */
function array_combine(array $keys,array $values){}
/** @return array */
function array_count_values(array $input){}
/** @return array */
function array_diff(array $array1,array $array2,array  $__args__ ){}
/** @return array */
function array_diff_assoc(array $array1,array $array2,array $__args__){}
/** @return array */
function array_diff_key(array $array1,array $array2,array $__args__){}
/** @return array */
function array_diff_uassoc(array $array1,array $array2,array $__args__,callable $key_compare_func){}
/** @return array */
function array_diff_ukey(array $array1,array $array2,array $__args__,callable $key_compare_func){}
/** @return array */
...
/** @return array */
function array_intersect(array $array1,array $array2,array $__args__){}
/** @return array */
function array_intersect_assoc(array $array1,array $array2,array $__args__){}
/** @return array */
function array_intersect_key(array $array1,array $array2,array $__args__){}
/** @return array */
function array_intersect_uassoc(array $array1,array $array2,array $__args__,callable $key_compare_func){}
/** @return array */
function array_intersect_ukey(array $array1,array $array2,array $__args__,callable $key_compare_func){}
/** @return bool */
function array_key_exists(mixed $key,array $search){}
/** @return array */
function array_keys(array $input,mixed $search_value,bool $strict){}
/** @return array */
function array_map(callable $callback,array $arr1,array $__args__){}
/** @return array */
function array_merge(array $array1,array $__args__){}
/** @return array */
function array_merge_recursive(array $array1,array $__args__){}
/** @return bool */
function array_multisort(array &$arr,mixed $arg,mixed $arg,mixed $__args__){}
/** @return array */
...
/** @return int */
function array_push(array &$array,mixed $var,mixed $__args__){}
/** @return mixed */
function array_rand(array $input,int $num_req){}
/** @return mixed */
function array_reduce(array $input,callable $function,mixed $initial){}
/** @return array */
function array_replace(array $array,array $array1,array $__args__){}
/** @return array */
function array_replace_recursive(array $array,array $array1,array $__args__){}
/** @return array */
...
/** @return array */
function array_slice(array $array,int $offset,int $length,bool $preserve_keys){}
/** @return array */
function array_splice(array &$input,int $offset,int $length,mixed $replacement){}
/** @return number */
function array_sum(array $array){}
/** @return array */
function array_udiff(array $array1,array $array2,array $__args__,callable $data_compare_func){}
/** @return array */
function array_udiff_assoc(array $array1,array $array2,array $__args__,callable $data_compare_func){}
/** @return array */
function array_udiff_uassoc(array $array1,array $array2,array $__args__,callable $data_compare_func,callable $key_compare_func){}
/** @return array */
function array_uintersect(array $array1,array $array2,array $__args__,callable $data_compare_func){}
/** @return array */
function array_uintersect_assoc(array $array1,array $array2,array $__args__,callable $data_compare_func){}
/** @return array */
function array_uintersect_uassoc(array $array1,array $array2,array $__args__,callable $data_compare_func,callable $key_compare_func){}
/** @return array */
function array_unique(array $array,int $sort_flags){}
/** @return int */
function array_unshift(array &$array,mixed $var,mixed $__args__){}
/** @return array */
function array_values(array $input){}
/** @return bool */
function array_walk(array &$array,callable $funcname,mixed $userdata){}
/** @return bool */
function array_walk_recursive(array &$input,callable $funcname,mixed $userdata){}
/** @return bool */
...
/** @return bool */
function assert(mixed $assertion,string $description){}
/** @return mixed */
...
/** @return string */
function base64_decode(string $data,bool $strict){}
/** @return string */
...
/** @return bool */
function bbcode_add_element(resource $bbcode_container,string $tag_name,array $tag_rules){}
/** @return bool */
function bbcode_add_smiley(resource $bbcode_container,string $smiley,string $replace_by){}
/** @return resource */
function bbcode_create(array $bbcode_initial_tags){}
/** @return bool */
function bbcode_destroy(resource $bbcode_container){}
/** @return string */
function bbcode_parse(resource $bbcode_container,string $to_parse){}
/** @return bool */
function bbcode_set_arg_parser(resource $bbcode_container,resource $bbcode_arg_parser){}
/** @return bool */
function bbcode_set_flags(resource $bbcode_container,int $flags,int $mode){}
/** @return string */
function bcadd(string $left_operand,string $right_operand,int $scale){}
/** @return int */
function bccomp(string $left_operand,string $right_operand,int $scale){}
/** @return string */
function bcdiv(string $left_operand,string $right_operand,int $scale){}
/** @return string */
function bcmod(string $left_operand,string $modulus){}
/** @return string */
function bcmul(string $left_operand,string $right_operand,int $scale){}
/** @return bool */
function bcompiler_load(string $filename){}
/** @return bool */
function bcompiler_load_exe(string $filename){}
/** @return bool */
function bcompiler_parse_class(string $class,string $callback){}
/** @return bool */
function bcompiler_read(resource $filehandle){}
/** @return bool */
function bcompiler_write_class(resource $filehandle,string $className,string $extends){}
/** @return bool */
function bcompiler_write_constant(resource $filehandle,string $constantName){}
/** @return bool */
function bcompiler_write_exe_footer(resource $filehandle,int $startpos){}
/** @return bool */
function bcompiler_write_file(resource $filehandle,string $filename){}
/** @return bool */
function bcompiler_write_footer(resource $filehandle){}
/** @return bool */
function bcompiler_write_function(resource $filehandle,string $functionName){}
/** @return bool */
function bcompiler_write_functions_from_file(resource $filehandle,string $fileName){}
/** @return bool */
function bcompiler_write_header(resource $filehandle,string $write_ver){}
/** @return bool */
function bcompiler_write_included_filename(resource $filehandle,string $filename){}
/** @return string */
function bcpowmod(string $left_operand,string $right_operand,string $modulus,int $scale){}
/** @return string */
function bcpow(string $left_operand,string $right_operand,int $scale){}
/** @return bool */
function bcscale(int $scale){}
/** @return string */
function bcsqrt(string $operand,int $scale){}
/** @return string */
function bcsub(string $left_operand,string $right_operand,int $scale){}
/** @return string */
...
/** @return string */
function blenc_encrypt(string $plaintext,string $encodedfile,string $encryption_key){}
/** @return boolean */
function boolval(mixed $var){}
/** @return array */
...
/** @return int */
function cairo_format_stride_for_width(int $format,int $width){}
/** @return CairoImageSurface */
function cairo_image_surface_create(int $format,int $width,int $height){}
/** @return CairoImageSurface */
function cairo_image_surface_create_for_data(string $data,int $format,int $width,int $height,int $stride){}
/** @return CairoImageSurface */
function cairo_image_surface_create_from_png(string $file){}
/** @return string */
...
/** @return array */
function cairo_matrix_transform_distance(CairoMatrix $matrix,float $dx,float $dy){}
/** @return array */
function cairo_matrix_transform_point(CairoMatrix $matrix,float $dx,float $dy){}
/** @return void */
...
/** @return CairoPattern */
function cairo_pattern_create_linear(float $x0,float $y0,float $x1,float $y1){}
/** @return CairoPattern */
function cairo_pattern_create_radial(float $x0,float $y0,float $r0,float $x1,float $y1,float $r1){}
/** @return CairoPattern */
function cairo_pattern_create_rgba(float $red,float $green,float $blue,float $alpha){}
/** @return CairoPattern */
function cairo_pattern_create_rgb(float $red,float $green,float $blue){}
/** @return int */
function cairo_pattern_get_color_stop_count(CairoGradientPattern $pattern){}
/** @return array */
function cairo_pattern_get_color_stop_rgba(CairoGradientPattern $pattern,int $index){}
/** @return int */
function cairo_pattern_get_extend(string $pattern){}
/** @return int */
...
function cairo_pdf_surface_create(string $file,float $width,float $height){}
/** @return void */
function cairo_pdf_surface_set_size(CairoPdfSurface $surface,float $width,float $height){}
/** @return array */
function cairo_ps_get_levels(){}
/** @return string */
function cairo_ps_level_to_string(int $level){}
/** @return CairoPsSurface */
function cairo_ps_surface_create(string $file,float $width,float $height){}
/** @return void */
...
/** @return array */
function cairo_scaled_font_text_extents(CairoScaledFont $scaledfont,string $text){}
/** @return void */
function cairo_surface_copy_page(CairoSurface $surface){}
/** @return CairoSurface */
function cairo_surface_create_similar(CairoSurface $surface,int $content,float $width,float $height){}
/** @return void */
...
/** @return void */
function cairo_surface_write_to_png(CairoSurface $surface,resource $stream){}
/** @return CairoSvgSurface */
function cairo_svg_surface_create(string $file,float $width,float $height){}
/** @return void */
function cairo_svg_surface_restrict_to_version(CairoSvgSurface $surface,int $version){}
/** @return string */
function cairo_svg_version_to_string(int $version){}
/** @return string */
function calculhmac(string $clent,string $data){}
/** @return string */
function calcul_hmac(string $clent,string $siretcode,string $price,string $reference,string $validity,string $taxation,string $devise,string $language){}
/** @return int */
...
/** @return mixed */
function call_user_func(callable $callback,mixed $parameter,mixed $__args__){}
/** @return mixed */
function call_user_method_array(string $method_name,object &$obj,array $paramarr){}
/** @return mixed */
function call_user_method(string $method_name,object &$obj,mixed $parameter,mixed $__args__){}
/** @return int */
function cal_to_jd(int $calendar,int $month,int $day,int $year){}
/** @return float */
function ceil(float $value){}
/** @return bool */
function chdb_create(string $pathname,array $data){}
/** @return bool */
...
/** @return string */
function chunk_split(string $body,int $chunklen,string $end){}
/** @return bool */
function class_alias(string $original,string $alias,bool $autoload){}
/** @return bool */
function class_exists(string $class_name,bool $autoload){}
/** @return array */
function class_implements(mixed $class,bool $autoload){}
/** @return array */
function classkit_import(string $filename){}
/** @return bool */
function classkit_method_add(string $classname,string $methodname,string $args,string $code,int $flags){}
/** @return bool */
function classkit_method_copy(string $dClass,string $dMethod,string $sClass,string $sMethod){}
/** @return bool */
function classkit_method_redefine(string $classname,string $methodname,string $args,string $code,int $flags){}
/** @return bool */
function classkit_method_remove(string $classname,string $methodname){}
/** @return bool */
function classkit_method_rename(string $classname,string $methodname,string $newname){}
/** @return array */
function class_parents(mixed $class,bool $autoload){}
/** @return array */
function class_uses(mixed $class,bool $autoload){}
/** @return void */
...
/** @return bool */
function com_event_sink(variant $comobject,object $sinkobject,mixed $sinkinterface){}
/** @return variant */
function com_get_active_object(string $progid,int $code_page){}
/** @return bool */
function com_load_typelib(string $typelib_name,bool $case_insensitive){}
/** @return bool */
function com_message_pump(int $timeoutms){}
/** @return array */
function compact(mixed $varname,mixed $__args__){}
/** @return bool */
function com_print_typeinfo(object $comobject,string $dispinterface,bool $wantsink){}
/** @return int */
...
/** @return bool */
function copy(string $source,string $dest,resource $context){}
/** @return float */
...
/** @return int */
function count(mixed $var,int $mode){}
/** @return bool */
...
/** @return int */
function cubrid_affected_rows(resource $conn_identifier){}
/** @return bool */
function cubrid_bind(resource $req_identifier,int $bind_index,mixed $bind_value,string $bind_value_type){}
/** @return string */
function cubrid_client_encoding(resource $conn_identifier){}
/** @return bool */
function cubrid_close(resource $conn_identifier){}
/** @return bool */
function cubrid_close_prepare(resource $req_identifier){}
/** @return bool */
function cubrid_close_request(resource $req_identifier){}
/** @return array */
function cubrid_col_get(resource $conn_identifier,string $oid,string $attr_name){}
/** @return int */
function cubrid_col_size(resource $conn_identifier,string $oid,string $attr_name){}
/** @return array */
...
/** @return resource */
function cubrid_connect(string $host,int $port,string $dbname,string $userid,string $passwd,bool $new_link){}
/** @return resource */
function cubrid_connect_with_url(string $conn_url,string $userid,string $passwd,bool $new_link){}
/** @return string */
function cubrid_current_oid(resource $req_identifier){}
/** @return bool */
function cubrid_data_seek(resource $result,int $row_number){}
/** @return string */
...
/** @return int */
function cubrid_errno(resource $conn_identifier){}
/** @return int */
...
/** @return string */
function cubrid_error(resource $connection){}
/** @return resource */
function cubrid_execute(resource $conn_identifier,string $sql,int $option){}
/** @return array */
function cubrid_fetch_array(resource $result,int $type){}
/** @return array */
function cubrid_fetch_assoc(resource $result,int $type){}
/** @return object */
function cubrid_fetch_field(resource $result,int $field_offset){}
/** @return array */
function cubrid_fetch_lengths(resource $result){}
/** @return mixed */
function cubrid_fetch(resource $result,int $type){}
/** @return object */
function cubrid_fetch_object(resource $result,string $class_name,array $params,int $type){}
/** @return array */
function cubrid_fetch_row(resource $result,int $type){}
/** @return string */
function cubrid_field_flags(resource $result,int $field_offset){}
/** @return int */
function cubrid_field_len(resource $result,int $field_offset){}
/** @return string */
function cubrid_field_name(resource $result,int $field_offset){}
/** @return bool */
function cubrid_field_seek(resource $result,int $field_offset){}
/** @return string */
function cubrid_field_table(resource $result,int $field_offset){}
/** @return string */
function cubrid_field_type(resource $result,int $field_offset){}
/** @return bool */
...
/** @return string */
function cubrid_get_class_name(resource $conn_identifier,string $oid){}
/** @return string */
function cubrid_get_client_info(){}
/** @return array */
function cubrid_get_db_parameter(resource $conn_identifier){}
/** @return mixed */
function cubrid_get(resource $conn_identifier,string $oid,mixed $attr){}
/** @return int */
...
/** @return array */
function cubrid_list_dbs(resource $conn_identifier){}
/** @return int */
function cubrid_load_from_glo(resource $conn_identifier,string $oid,string $file_name){}
/** @return bool */
function cubrid_lob2_bind(resource $req_identifier,int $bind_index,mixed $bind_value,string $bind_value_type){}
/** @return bool */
function cubrid_lob2_close(resource $lob_identifier){}
/** @return bool */
function cubrid_lob2_export(resource $lob_identifier,string $file_name){}
/** @return bool */
function cubrid_lob2_import(resource $lob_identifier,string $file_name){}
/** @return resource */
function cubrid_lob2_new(resource $conn_identifier,string $type){}
/** @return string */
function cubrid_lob2_read(resource $lob_identifier,int $len){}
/** @return bool */
function cubrid_lob2_seek64(resource $lob_identifier,string $offset,int $origin){}
/** @return bool */
function cubrid_lob2_seek(resource $lob_identifier,int $offset,int $origin){}
/** @return string */
...
/** @return bool */
function cubrid_lob_export(resource $conn_identifier,resource $lob_identifier,string $path_name){}
/** @return array */
function cubrid_lob_get(resource $conn_identifier,string $sql){}
/** @return bool */
function cubrid_lob_send(resource $conn_identifier,resource $lob_identifier){}
/** @return string */
...
/** @return int */
function cubrid_move_cursor(resource $req_identifier,int $offset,int $origin){}
/** @return string */
function cubrid_new_glo(resource $conn_identifier,string $class_name,string $file_name){}
/** @return bool */
function cubrid_next_result(resource $result){}
/** @return int */
function cubrid_num_cols(resource $result){}
/** @return int */
function cubrid_num_fields(resource $result){}
/** @return int */
...
/** @return bool */
function cubrid_ping(resource $conn_identifier){}
/** @return resource */
function cubrid_prepare(resource $conn_identifier,string $prepare_stmt,int $option){}
/** @return int */
function cubrid_put(resource $conn_identifier,string $oid,string $attr,mixed $value){}
/** @return resource */
function cubrid_query(string $query,resource $conn_identifier){}
/** @return string */
function cubrid_real_escape_string(string $unescaped_string,resource $conn_identifier){}
/** @return string */
function cubrid_result(resource $result,int $row,mixed $field){}
/** @return bool */
function cubrid_rollback(resource $conn_identifier){}
/** @return int */
function cubrid_save_to_glo(resource $conn_identifier,string $oid,string $file_name){}
/** @return array */
function cubrid_schema(resource $conn_identifier,int $schema_type,string $class_name,string $attr_name){}
/** @return int */
function cubrid_send_glo(resource $conn_identifier,string $oid){}
/** @return bool */
function cubrid_seq_drop(resource $conn_identifier,string $oid,string $attr_name,int $index){}
/** @return bool */
function cubrid_seq_insert(resource $conn_identifier,string $oid,string $attr_name,int $index,string $seq_element){}
/** @return bool */
function cubrid_seq_put(resource $conn_identifier,string $oid,string $attr_name,int $index,string $seq_element){}
/** @return bool */
function cubrid_set_add(resource $conn_identifier,string $oid,string $attr_name,string $set_element){}
/** @return bool */
function cubrid_set_autocommit(resource $conn_identifier,bool $mode){}
/** @return bool */
function cubrid_set_db_parameter(resource $conn_identifier,int $param_type,int $param_value){}
/** @return bool */
function cubrid_set_drop(resource $conn_identifier,string $oid,string $attr_name,string $set_element){}
/** @return bool */
function cubrid_set_query_timeout(resource $req_identifier,int $timeout){}
/** @return resource */
function cubrid_unbuffered_query(string $query,resource $conn_identifier){}
/** @return string */
...
/** @return string */
function curl_escape(resource $ch,string $str){}
/** @return mixed */
...
/** @return array */
function curl_multi_info_read(resource $mh,int &$msgs_in_queue){}
/** @return resource */
...
/** @return bool */
function curl_multi_setopt(resource $mh,int $option,mixed $value){}
/** @return string */
function curl_multi_strerror(int $errornum){}
/** @return int */
function curl_pause(resource $ch,int $bitmask){}
/** @return void */
...
/** @return bool */
function curl_share_setopt(resource $sh,int $option,string $value){}
/** @return string */
function curl_strerror(int $errornum){}
/** @return string */
function curl_unescape(resource $ch,string $str){}
/** @return array */
function curl_version(int $age){}
/** @return mixed */
function current(array &$array){}
/** @return void */
function cyrus_authenticate(resource $connection,string $mechlist,string $service,string $user,int $minssf,int $maxssf,string $authname,string $password){}
/** @return bool */
...
/** @return mixed */
function date_sunrise(int $timestamp,int $format,float $latitude,float $longitude,float $zenith,float $gmt_offset){}
/** @return mixed */
function date_sunset(int $timestamp,int $format,float $latitude,float $longitude,float $zenith,float $gmt_offset){}
/** @return mixed */
function db2_autocommit(resource $connection,bool $value){}
/** @return bool */
function db2_bind_param(resource $stmt,int $parameter_number,string $variable_name,int $parameter_type,int $data_type,int $precision,int $scale){}
/** @return object */
function db2_client_info(resource $connection){}
/** @return bool */
function db2_close(resource $connection){}
/** @return resource */
function db2_column_privileges(resource $connection,string $qualifier,string $schema,string $table_name,string $column_name){}
/** @return resource */
function db2_columns(resource $connection,string $qualifier,string $schema,string $table_name,string $column_name){}
/** @return bool */
...
/** @return string */
function db2_conn_errormsg(resource $connection){}
/** @return string */
function db2_conn_error(resource $connection){}
/** @return int */
function db2_cursor_type(resource $stmt){}
/** @return string */
function db2_escape_string(string $string_literal){}
/** @return resource */
function db2_exec(resource $connection,string $statement,array $options){}
/** @return bool */
function db2_execute(resource $stmt,array $parameters){}
/** @return array */
function db2_fetch_array(resource $stmt,int $row_number){}
/** @return array */
function db2_fetch_assoc(resource $stmt,int $row_number){}
/** @return array */
function db2_fetch_both(resource $stmt,int $row_number){}
/** @return object */
function db2_fetch_object(resource $stmt,int $row_number){}
/** @return bool */
function db2_fetch_row(resource $stmt,int $row_number){}
/** @return int */
function db2_field_display_size(resource $stmt,mixed $column){}
/** @return string */
function db2_field_name(resource $stmt,mixed $column){}
/** @return int */
function db2_field_num(resource $stmt,mixed $column){}
/** @return int */
function db2_field_precision(resource $stmt,mixed $column){}
/** @return int */
function db2_field_scale(resource $stmt,mixed $column){}
/** @return string */
function db2_field_type(resource $stmt,mixed $column){}
/** @return int */
function db2_field_width(resource $stmt,mixed $column){}
/** @return resource */
function db2_foreign_keys(resource $connection,string $qualifier,string $schema,string $table_name){}
/** @return bool */
...
/** @return bool */
function db2_pclose(resource $resource){}
/** @return resource */
function db2_pconnect(string $database,string $username,string $password,array $options){}
/** @return resource */
function db2_prepare(resource $connection,string $statement,array $options){}
/** @return resource */
function db2_primary_keys(resource $connection,string $qualifier,string $schema,string $table_name){}
/** @return resource */
function db2_procedure_columns(resource $connection,string $qualifier,string $schema,string $procedure,string $parameter){}
/** @return resource */
function db2_procedures(resource $connection,string $qualifier,string $schema,string $procedure){}
/** @return mixed */
function db2_result(resource $stmt,mixed $column){}
/** @return bool */
function db2_rollback(resource $connection){}
/** @return object */
function db2_server_info(resource $connection){}
/** @return bool */
function db2_set_option(resource $resource,array $options,int $type){}
/** @return resource */
function db2_special_columns(resource $connection,string $qualifier,string $schema,string $table_name,int $scope){}
/** @return resource */
function db2_statistics(resource $connection,string $qualifier,string $schema,string $table_name,bool $unique){}
/** @return string */
function db2_stmt_errormsg(resource $stmt){}
/** @return string */
function db2_stmt_error(resource $stmt){}
/** @return resource */
function db2_table_privileges(resource $connection,string $qualifier,string $schema,string $table_name){}
/** @return resource */
function db2_tables(resource $connection,string $qualifier,string $schema,string $table_name,string $table_type){}
/** @return void */
...
/** @return array */
function dba_handlers(bool $full_info){}
/** @return bool */
...
/** @return resource */
function dba_open(string $path,string $mode,string $handler,mixed $__args__){}
/** @return bool */
function dba_optimize(resource $handle){}
/** @return resource */
function dba_popen(string $path,string $mode,string $handler,mixed $__args__){}
/** @return bool */
...
/** @return bool */
function dbase_delete_record(int $dbase_identifier,int $record_number){}
/** @return array */
function dbase_get_header_info(int $dbase_identifier){}
/** @return array */
function dbase_get_record(int $dbase_identifier,int $record_number){}
/** @return array */
function dbase_get_record_with_names(int $dbase_identifier,int $record_number){}
/** @return int */
...
/** @return bool */
function dbase_replace_record(int $dbase_identifier,array $record,int $record_number){}
/** @return bool */
...
/** @return int */
function dbplus_freelock(resource $relation,string $tuple){}
/** @return int */
function dbplus_freerlocks(resource $relation){}
/** @return int */
function dbplus_getlock(resource $relation,string $tuple){}
/** @return int */
function dbplus_getunique(resource $relation,int $uniqueid){}
/** @return int */
function dbplus_info(resource $relation,string $key,array &$result){}
/** @return int */
function dbplus_last(resource $relation,array &$tuple){}
/** @return int */
function dbplus_lockrel(resource $relation){}
/** @return int */
function dbplus_next(resource $relation,array &$tuple){}
/** @return resource */
...
/** @return mixed */
function dbplus_rcrtlike(string $name,resource $relation,int $overwrite){}
/** @return array */
...
/** @return array */
function debug_backtrace(int $options,int $limit){}
/** @return void */
function debug_print_backtrace(int $options,int $limit){}
/** @return void */
function debug_zval_dump(mixed $variable,mixed $__args__){}
/** @return string */
...
/** @return bool */
function define(string $name,mixed $value,bool $case_insensitive){}
/** @return bool */
...
/** @return string */
function dio_read(resource $fd,int $len){}
/** @return int */
...
/** @return Directory */
function dir(string $directory,resource $context){}
/** @return string */
...
/** @return array */
function dns_get_record(string $hostname,int $type,array &$authns,array &$addtl,bool &$raw){}
/** @return DOMElement */
...
/** @return int */
function easter_days(int $year,int $method){}

/** @return resource */
function eio_busy(int $delay,int $pri,callable $callback,mixed $data){}
/** @return void */
function eio_cancel(resource $req){}
/** @return resource */
function eio_chmod(string $path,int $mode,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_chown(string $path,int $uid,int $gid,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_close(mixed $fd,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_custom(callable $execute,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_dup2(mixed $fd,mixed $fd2,int $pri,callable $callback,mixed $data){}
/** @return bool */
function eio_event_loop(){}
/** @return resource */
function eio_fallocate(mixed $fd,int $mode,int $offset,int $length,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_fchmod(mixed $fd,int $mode,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_fchown(mixed $fd,int $uid,int $gid,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_fdatasync(mixed $fd,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_fstat(mixed $fd,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_fstatvfs(mixed $fd,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_fsync(mixed $fd,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_ftruncate(mixed $fd,int $offset,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_futime(mixed $fd,float $atime,float $mtime,int $pri,callable $callback,mixed $data){}
/** @return mixed */
...
/** @return resource */
function eio_grp(callable $callback,string $data){}
/** @return void */
function eio_init(){}
/** @return resource */
function eio_link(string $path,string $new_path,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_lstat(string $path,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_mkdir(string $path,int $mode,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_mknod(string $path,int $mode,int $dev,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_nop(int $pri,callable $callback,mixed $data){}
/** @return int */
...
/** @return resource */
function eio_open(string $path,int $flags,int $mode,int $pri,callable $callback,mixed $data){}
/** @return int */
function eio_poll(){}
/** @return resource */
function eio_readahead(mixed $fd,int $offset,int $length,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_readdir(string $path,int $flags,int $pri,callable $callback,string $data){}
/** @return resource */
function eio_readlink(string $path,int $pri,callable $callback,string $data){}
/** @return resource */
function eio_read(mixed $fd,int $length,int $offset,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_realpath(string $path,int $pri,callable $callback,string $data){}
/** @return resource */
function eio_rename(string $path,string $new_path,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_rmdir(string $path,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_seek(mixed $fd,int $offset,int $whence,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_sendfile(mixed $out_fd,mixed $in_fd,int $offset,int $length,int $pri,callable $callback,string $data){}
/** @return void */
...
/** @return resource */
function eio_stat(string $path,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_statvfs(string $path,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_symlink(string $path,string $new_path,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_sync_file_range(mixed $fd,int $offset,int $nbytes,int $flags,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_syncfs(mixed $fd,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_sync(int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_truncate(string $path,int $offset,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_unlink(string $path,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_utime(string $path,float $atime,float $mtime,int $pri,callable $callback,mixed $data){}
/** @return resource */
function eio_write(mixed $fd,string $str,int $length,int $offset,int $pri,callable $callback,mixed $data){}
/** @return bool */
//function empty(mixed $var){}
/** @return array */
function enchant_broker_describe(resource $broker){}
/** @return bool */
function enchant_broker_dict_exists(resource $broker,string $tag){}
/** @return bool */
function enchant_broker_free(resource $broker){}
/** @return bool */
function enchant_broker_free_dict(resource $dict){}
/** @return string */
function enchant_broker_get_error(resource $broker){}
/** @return resource */
function enchant_broker_init(){}
/** @return mixed */
function enchant_broker_list_dicts(resource $broker){}
/** @return resource */
function enchant_broker_request_dict(resource $broker,string $tag){}
/** @return resource */
function enchant_broker_request_pwl_dict(resource $broker,string $filename){}
/** @return bool */
function enchant_broker_set_ordering(resource $broker,string $tag,string $ordering){}
/** @return void */
function enchant_dict_add_to_personal(resource $dict,string $word){}
/** @return void */
function enchant_dict_add_to_session(resource $dict,string $word){}
/** @return bool */
function enchant_dict_check(resource $dict,string $word){}
/** @return mixed */
function enchant_dict_describe(resource $dict){}
/** @return string */
function enchant_dict_get_error(resource $dict){}
/** @return bool */
function enchant_dict_is_in_session(resource $dict,string $word){}
/** @return bool */
function enchant_dict_quick_check(resource $dict,string $word,array &$suggestions){}
/** @return void */
function enchant_dict_store_replacement(resource $dict,string $mis,string $cor){}
/** @return array */
function enchant_dict_suggest(resource $dict,string $word){}
/** @return mixed */
...
/** @return bool */
function event_add(resource $event,int $timeout){}
/** @return void */
function event_base_free(resource $event_base){}
/** @return bool */
function event_base_loopbreak(resource $event_base){}
/** @return bool */
function event_base_loopexit(resource $event_base,int $timeout){}
/** @return int */
function event_base_loop(resource $event_base,int $flags){}
/** @return resource */
function event_base_new(){}
/** @return bool */
function event_base_priority_init(resource $event_base,int $npriorities){}
/** @return bool */
function event_base_reinit(resource $event_base){}
/** @return bool */
function event_base_set(resource $event,resource $event_base){}
/** @return bool */
function event_buffer_base_set(resource $bevent,resource $event_base){}
/** @return bool */
function event_buffer_disable(resource $bevent,int $events){}
/** @return bool */
function event_buffer_enable(resource $bevent,int $events){}
/** @return void */
function event_buffer_fd_set(resource $bevent,resource $fd){}
/** @return void */
function event_buffer_free(resource $bevent){}
/** @return resource */
function event_buffer_new(resource $stream,mixed $readcb,mixed $writecb,mixed $errorcb,mixed $arg){}
/** @return bool */
function event_buffer_priority_set(resource $bevent,int $priority){}
/** @return string */
function event_buffer_read(resource $bevent,int $data_size){}
/** @return bool */
function event_buffer_set_callback(resource $event,mixed $readcb,mixed $writecb,mixed $errorcb,mixed $arg){}
/** @return void */
...
/** @return bool */
function event_buffer_write(resource $bevent,string $data,int $data_size){}
/** @return bool */
function event_del(resource $event){}
/** @return void */
function event_free(resource $event){}
/** @return resource */
function event_new(){}
/** @return bool */
function event_priority_set(resource $event,int $priority){}
/** @return bool */
function event_set(resource $event,mixed $fd,int $events,mixed $callback,mixed $arg){}
/** @return bool */
function event_timer_set(resource $event,callable $callback,mixed $arg){}
/** @return string */
function exec(string $command,array &$output,int &$return_var){}
/** @return int */
...
/** @return int */
function expect_expectl(resource $expect,array $cases,array &$match){}
/** @return resource */
...
/** @return bool */
function fann_cascadetrain_on_data(resource $ann,resource $data,int $max_neurons,int $neurons_between_reports,float $desired_error){}
/** @return bool */
function fann_cascadetrain_on_file(resource $ann,string $filename,int $max_neurons,int $neurons_between_reports,float $desired_error){}
/** @return bool */
...
/** @return reference */
function fann_create_shortcut(int $num_layers,int $num_neurons1,int $num_neurons2,int $__args__){}
/** @return ReturnType */
function fann_create_sparse_array(float $connection_rate,int $num_layers,array $layers){}
/** @return ReturnType */
function fann_create_sparse(float $connection_rate,int $num_layers,int $num_neurons1,int $num_neurons2,int $__args__){}
/** @return resource */
function fann_create_standard_array(int $num_layers,array $layers){}
/** @return resource */
function fann_create_standard(int $num_layers,int $num_neurons1,int $num_neurons2,int $__args__){}
/** @return resource */
function fann_create_train_from_callback(int $num_data,int $num_input,int $num_output,collable $user_function){}
/** @return resource */
...
/** @return int */
function fann_get_activation_function(resource $ann,int $layer,int $neuron){}
/** @return float */
function fann_get_activation_steepness(resource $ann,int $layer,int $neuron){}
/** @return array */
...
/** @return int */
function fann_get_cascade_activation_steepnesses_count(resource $ann){}
/** @return float */
...
/** @return bool */
function fann_randomize_weights(resource $ann,float $min_weight,float $max_weight){}
/** @return resource */
...
/** @return bool */
function fann_scale_input_train_data(resource $train_data,float $new_min,float $new_max){}
/** @return bool */
function fann_scale_output(resource $ann,array $output_vector){}
/** @return bool */
function fann_scale_output_train_data(resource $train_data,float $new_min,float $new_max){}
/** @return bool */
function fann_scale_train(resource $ann,resource $train_data){}
/** @return bool */
function fann_scale_train_data(resource $train_data,float $new_min,float $new_max){}
/** @return bool */
function fann_set_activation_function(resource $ann,int $activation_function,int $layer,int $neuron){}
/** @return bool */
function fann_set_activation_function_hidden(resource $ann,int $activation_function){}
/** @return bool */
function fann_set_activation_function_layer(resource $ann,int $activation_function,int $layer){}
/** @return bool */
function fann_set_activation_function_output(resource $ann,int $activation_function){}
/** @return bool */
function fann_set_activation_steepness(resource $ann,float $activation_steepness,int $layer,int $neuron){}
/** @return bool */
function fann_set_activation_steepness_hidden(resource $ann,float $activation_steepness){}
/** @return bool */
function fann_set_activation_steepness_layer(resource $ann,float $activation_steepness,int $layer){}
/** @return bool */
function fann_set_activation_steepness_output(resource $ann,float $activation_steepness){}
/** @return bool */
function fann_set_bit_fail_limit(resource $ann,float $bit_fail_limit){}
/** @return bool */
function fann_set_callback(resource $ann,collable $callback){}
/** @return bool */
function fann_set_cascade_activation_functions(resource $ann,array $cascade_activation_functions){}
/** @return bool */
function fann_set_cascade_activation_steepnesses(resource $ann,array $cascade_activation_steepnesses_count){}
/** @return bool */
function fann_set_cascade_candidate_change_fraction(resource $ann,float $cascade_candidate_change_fraction){}
/** @return bool */
function fann_set_cascade_candidate_limit(resource $ann,float $cascade_candidate_limit){}
/** @return bool */
function fann_set_cascade_candidate_stagnation_epochs(resource $ann,int $cascade_candidate_stagnation_epochs){}
/** @return bool */
function fann_set_cascade_max_cand_epochs(resource $ann,int $cascade_max_cand_epochs){}
/** @return bool */
function fann_set_cascade_max_out_epochs(resource $ann,int $cascade_max_out_epochs){}
/** @return bool */
function fann_set_cascade_min_cand_epochs(resource $ann,int $cascade_min_cand_epochs){}
/** @return bool */
function fann_set_cascade_min_out_epochs(resource $ann,int $cascade_min_out_epochs){}
/** @return bool */
function fann_set_cascade_num_candidate_groups(resource $ann,int $cascade_num_candidate_groups){}
/** @return bool */
function fann_set_cascade_output_change_fraction(resource $ann,float $cascade_output_change_fraction){}
/** @return bool */
function fann_set_cascade_output_stagnation_epochs(resource $ann,int $cascade_output_stagnation_epochs){}
/** @return bool */
function fann_set_cascade_weight_multiplier(resource $ann,float $cascade_weight_multiplier){}
/** @return void */
function fann_set_error_log(resource $errdat,string $log_file){}
/** @return bool */
function fann_set_input_scaling_params(resource $ann,resource $train_data,float $new_input_min,float $new_input_max){}
/** @return bool */
function fann_set_learning_momentum(resource $ann,float $learning_momentum){}
/** @return bool */
function fann_set_learning_rate(resource $ann,float $learning_rate){}
/** @return bool */
function fann_set_output_scaling_params(resource $ann,resource $train_data,float $new_output_min,float $new_output_max){}
/** @return bool */
function fann_set_quickprop_decay(resource $ann,float $quickprop_decay){}
/** @return bool */
function fann_set_quickprop_mu(resource $ann,float $quickprop_mu){}
/** @return bool */
function fann_set_rprop_decrease_factor(resource $ann,float $rprop_decrease_factor){}
/** @return bool */
function fann_set_rprop_delta_max(resource $ann,float $rprop_delta_max){}
/** @return bool */
function fann_set_rprop_delta_min(resource $ann,float $rprop_delta_min){}
/** @return bool */
function fann_set_rprop_delta_zero(resource $ann,float $rprop_delta_zero){}
/** @return bool */
function fann_set_rprop_increase_factor(resource $ann,float $rprop_increase_factor){}
/** @return bool */
function fann_set_sarprop_step_error_shift(resource $ann,float $sarprop_step_error_shift){}
/** @return bool */
function fann_set_sarprop_step_error_threshold_factor(resource $ann,float $sarprop_step_error_threshold_factor){}
/** @return bool */
function fann_set_sarprop_temperature(resource $ann,float $sarprop_temperature){}
/** @return bool */
function fann_set_sarprop_weight_decay_shift(resource $ann,float $sarprop_weight_decay_shift){}
/** @return bool */
function fann_set_scaling_params(resource $ann,resource $train_data,float $new_input_min,float $new_input_max,float $new_output_min,float $new_output_max){}
/** @return bool */
function fann_set_train_error_function(resource $ann,int $error_function){}
/** @return bool */
function fann_set_training_algorithm(resource $ann,int $training_algorithm){}
/** @return bool */
function fann_set_train_stop_function(resource $ann,int $stop_function){}
/** @return bool */
function fann_set_weight_array(resource $ann,array $connections){}
/** @return bool */
function fann_set_weight(resource $ann,int $from_neuron,int $to_neuron,float $weight){}
/** @return bool */
function fann_shuffle_train_data(resource $train_data){}
/** @return resource */
function fann_subset_train_data(resource $data,int $pos,int $length){}
/** @return bool */
function fann_test(resource $ann,array $input,array $desired_output){}
/** @return float */
function fann_test_data(resource $ann,resource $data){}
/** @return bool */
function fann_train(resource $ann,array $input,array $desired_output){}
/** @return float */
function fann_train_epoch(resource $ann,resource $data){}
/** @return bool */
function fann_train_on_data(resource $ann,resource $data,int $max_epochs,int $epochs_between_reports,float $desired_error){}
/** @return bool */
function fann_train_on_file(resource $ann,string $filename,int $max_epochs,int $epochs_between_reports,float $desired_error){}
/** @return boolean */
...
/** @return int */
function fbsql_blob_size(string $blob_handle,resource $link_identifier){}
/** @return bool */
function fbsql_change_user(string $user,string $password,string $database,resource $link_identifier){}
/** @return int */
function fbsql_clob_size(string $clob_handle,resource $link_identifier){}
/** @return bool */
...
/** @return bool */
function fbsql_create_db(string $database_name,resource $link_identifier,string $database_options){}
/** @return string */
...
/** @return bool */
function fbsql_data_seek(resource $result,int $row_number){}
/** @return resource */
...
/** @return object */
function fbsql_fetch_object(resource $result){}
/** @return array */
...
/** @return bool */
function fbsql_next_result(resource $result){}
/** @return int */
...
/** @return resource */
function fbsql_query(string $query,resource $link_identifier,int $batch_size){}
/** @return string */
...
/** @return int */
function fbsql_rows_fetched(resource $result){}
/** @return bool */
function fbsql_select_db(string $database_name,resource $link_identifier){}
/** @return void */
function fbsql_set_characterset(resource $link_identifier,int $characterset,int $in_out_both){}
/** @return bool */
function fbsql_set_lob_mode(resource $result,int $lob_mode){}
/** @return bool */
function fbsql_set_password(resource $link_identifier,string $user,string $password,string $old_password){}
/** @return void */
function fbsql_set_transaction(resource $link_identifier,int $locking,int $isolation){}
/** @return bool */
function fbsql_start_db(string $database_name,resource $link_identifier,string $database_options){}
/** @return bool */
function fbsql_stop_db(string $database_name,resource $link_identifier){}
/** @return string */
function fbsql_table_name(resource $result,int $index){}
/** @return string */
...
/** @return bool */
function fdf_add_doc_javascript(resource $fdf_document,string $script_name,string $script_code){}
/** @return bool */
function fdf_add_template(resource $fdf_document,int $newpage,string $filename,string $template,int $rename){}
/** @return void */
function fdf_close(resource $fdf_document){}
/** @return resource */
function fdf_create(){}
/** @return bool */
function fdf_enum_values(resource $fdf_document,callable $function,mixed $userdata){}
/** @return int */
function fdf_errno(){}
/** @return string */
...
/** @return int */
function fdf_get_flags(resource $fdf_document,string $fieldname,int $whichflags){}
/** @return mixed */
function fdf_get_opt(resource $fdf_document,string $fieldname,int $element){}
/** @return string */
...
/** @return bool */
function fdf_remove_item(resource $fdf_document,string $fieldname,int $item){}
/** @return bool */
...
/** @return bool */
function fdf_set_on_import_javascript(resource $fdf_document,string $script,bool $before_data_import){}
/** @return bool */
...
/** @return array */
function fgetcsv(resource $handle,int $length,string $delimiter,string $enclosure,string $escape){}
/** @return string */
function fgetss(resource $handle,int $length,string $allowable_tags){}
/** @return string */
function fgets(resource $handle,int $length){}
/** @return array */
function file(string $filename,int $flags,resource $context){}
/** @return int */
...
/** @return string */
function file_get_contents(string $filename,bool $use_include_path,resource $context,int $offset,int $maxlen){}
/** @return int */
...
/** @return int */
function file_put_contents(string $filename,mixed $data,int $flags,resource $context){}
/** @return int */
...
/** @return mixed */
function filter_input(int $type,string $variable_name,int $filter,mixed $options){}
/** @return array */
function filter_list(){}
/** @return mixed */
function filter_var_array(array $data,mixed $definition,bool $add_empty){}
/** @return mixed */
function filter_var(mixed $variable,int $filter,mixed $options){}
/** @return string */
function finfo_buffer(resource $finfo,string $string,int $options,resource $context){}
/** @return bool */
function finfo_close(resource $finfo){}
/** @return string */
function finfo_file(resource $finfo,string $file_name,int $options,resource $context){}
/** @return resource */
function finfo_open(int $options,string $magic_file){}
/** @return bool */
function finfo_set_flags(resource $finfo,int $options){}
/** @return float */
function floatval(mixed $var){}
/** @return bool */
function flock(resource $handle,int $operation,int &$wouldblock){}
/** @return float */
...
/** @return resource */
function fopen(string $filename,string $mode,bool $use_include_path,resource $context){}
/** @return mixed */
function forward_static_call_array(callable $function,array $parameters){}
/** @return mixed */
function forward_static_call(callable $function,mixed $parameter,mixed $__args__){}
/** @return int */
function fpassthru(resource $handle){}
/** @return int */
function fprintf(resource $handle,string $format,mixed $args,mixed $__args__){}
/** @return int */
function fputcsv(resource $handle,array $fields,string $delimiter,string $enclosure){}
/** @return string */
...
/** @return mixed */
function fscanf(resource $handle,string $format,mixed &$__args__){}
/** @return int */
function fseek(resource $handle,int $offset,int $whence){}
/** @return resource */
...
/** @return bool */
function ftp_rename(resource $ftp_stream,string $oldname,string $newname){}
/** @return bool */
...
/** @return string */
function geoip_database_info(int $database){}
/** @return bool */
...
/** @return array */
function get_class_methods(mixed $class_name){}
/** @return string */
...
/** @return array */
function get_defined_constants(bool $categorize){}
/** @return array */
...
/** @return array */
function get_headers(string $url,int $format){}
/** @return string */
...
/** @return array */
function get_html_translation_table(int $table,int $flags,string $encoding){}
/** @return array */
function getimagesize(string $filename,array &$imageinfo){}
/** @return array */
function getimagesizefromstring(string $imagedata,array &$imageinfo){}
/** @return array */
...
function getlastmod(){}
/** @return array */
function get_loaded_extensions(bool $zend_extensions){}
/** @return bool */
...
/** @return array */
function getopt(string $options,array $longopts){}
/** @return string */
function get_parent_class(mixed $obj){}
/** @return int */
...
/** @return mixed */
function gettimeofday(bool $return_float){}
/** @return string */
...
/** @return GMP */
function gmp_div_q(GMP $a,GMP $b,int $round){}
/** @return array */
function gmp_div_qr(GMP $n,GMP $d,int $round){}
/** @return GMP */
function gmp_div_r(GMP $n,GMP $d,int $round){}
/** @return string */
function gmp_export(GMP $gmpnumber,integer $word_size,integer $options){}
/** @return GMP */
function gmp_fact(mixed $a){}
/** @return array */
...
/** @return GMP */
function gmp_import(string $data,integer $word_size,integer $options){}
/** @return GMP */
function gmp_init(mixed $number,int $base){}
/** @return int */
...
/** @return int */
function gmp_prob_prime(GMP $a,int $reps){}
/** @return GMP */
...
/** @return void */
function gmp_setbit(GMP &$a,int $index,bool $bit_on){}
/** @return int */
...
/** @return string */
function gmp_strval(GMP $gmpnumber,int $base){}
/** @return GMP */
...
/** @return bool */
function gnupg_adddecryptkey(resource $identifier,string $fingerprint,string $passphrase){}
/** @return bool */
function gnupg_addencryptkey(resource $identifier,string $fingerprint){}
/** @return bool */
function gnupg_addsignkey(resource $identifier,string $fingerprint,string $passphrase){}
/** @return bool */
...
/** @return array */
function gnupg_decryptverify(resource $identifier,string $text,string &$plaintext){}
/** @return string */
...
/** @return array */
function gnupg_verify(resource $identifier,string $signed_text,string $signature,string &$plaintext){}
/** @return array */
function gopher_parsedir(string $dirent){}
/** @return string */
function grapheme_extract(string $haystack,int $size,int $extract_type,int $start,int &$next){}
/** @return int */
function grapheme_stripos(string $haystack,string $needle,int $offset){}
/** @return string */
function grapheme_stristr(string $haystack,string $needle,bool $before_needle){}
/** @return int */
function grapheme_strlen(string $input){}
/** @return int */
function grapheme_strpos(string $haystack,string $needle,int $offset){}
/** @return int */
function grapheme_strripos(string $haystack,string $needle,int $offset){}
/** @return int */
function grapheme_strrpos(string $haystack,string $needle,int $offset){}
/** @return string */
function grapheme_strstr(string $haystack,string $needle,bool $before_needle){}
/** @return int */
function grapheme_substr(string $string,int $start,int $length){}
/** @return int */
function gregoriantojd(int $month,int $day,int $year){}
/** @return string */
function gupnp_context_get_host_ip(resource $context){}
/** @return int */
function gupnp_context_get_port(resource $context){}
/** @return int */
function gupnp_context_get_subscription_timeout(resource $context){}
/** @return bool */
function gupnp_context_host_path(resource $context,string $local_path,string $server_path){}
/** @return resource */
function gupnp_context_new(string $host_ip,int $port){}
/** @return void */
function gupnp_context_set_subscription_timeout(resource $context,int $timeout){}
/** @return bool */
function gupnp_context_timeout_add(resource $context,int $timeout,mixed $callback,mixed $arg){}
/** @return bool */
function gupnp_context_unhost_path(resource $context,string $server_path){}
/** @return bool */
function gupnp_control_point_browse_start(resource $cpoint){}
/** @return bool */
function gupnp_control_point_browse_stop(resource $cpoint){}
/** @return bool */
function gupnp_control_point_callback_set(resource $cpoint,int $signal,mixed $callback,mixed $arg){}
/** @return resource */
function gupnp_control_point_new(resource $context,string $target){}
/** @return bool */
function gupnp_device_action_callback_set(resource $root_device,int $signal,string $action_name,mixed $callback,mixed $arg){}
/** @return array */
function gupnp_device_info_get(resource $root_device){}
/** @return resource */
function gupnp_device_info_get_service(resource $root_device,string $type){}
/** @return bool */
function gupnp_root_device_get_available(resource $root_device){}
/** @return string */
function gupnp_root_device_get_relative_location(resource $root_device){}
/** @return resource */
function gupnp_root_device_new(resource $context,string $location,string $description_dir){}
/** @return bool */
function gupnp_root_device_set_available(resource $root_device,bool $available){}
/** @return bool */
function gupnp_root_device_start(resource $root_device){}
/** @return bool */
function gupnp_root_device_stop(resource $root_device){}
/** @return mixed */
function gupnp_service_action_get(resource $action,string $name,int $type){}
/** @return bool */
function gupnp_service_action_return(resource $action){}
/** @return bool */
function gupnp_service_action_return_error(resource $action,int $error_code,string $error_description){}
/** @return bool */
function gupnp_service_action_set(resource $action,string $name,int $type,mixed $value){}
/** @return bool */
function gupnp_service_freeze_notify(resource $service){}
/** @return array */
function gupnp_service_info_get(resource $proxy){}
/** @return mixed */
function gupnp_service_info_get_introspection(resource $proxy,mixed $callback,mixed $arg){}
/** @return array */
function gupnp_service_introspection_get_state_variable(resource $introspection,string $variable_name){}
/** @return bool */
function gupnp_service_notify(resource $service,string $name,int $type,mixed $value){}
/** @return mixed */
function gupnp_service_proxy_action_get(resource $proxy,string $action,string $name,int $type){}
/** @return bool */
function gupnp_service_proxy_action_set(resource $proxy,string $action,string $name,mixed $value,int $type){}
/** @return bool */
function gupnp_service_proxy_add_notify(resource $proxy,string $value,int $type,mixed $callback,mixed $arg){}
/** @return bool */
function gupnp_service_proxy_callback_set(resource $proxy,int $signal,mixed $callback,mixed $arg){}
/** @return bool */
function gupnp_service_proxy_get_subscribed(resource $proxy){}
/** @return bool */
function gupnp_service_proxy_remove_notify(resource $proxy,string $value){}
/** @return bool */
function gupnp_service_proxy_set_subscribed(resource $proxy,bool $subscribed){}
/** @return bool */
function gupnp_service_thaw_notify(resource $service){}
/** @return bool */
function gzclose(resource $zp){}
/** @return string */
function gzcompress(string $data,int $level,int $encoding){}
/** @return string */
function gzdecode(string $data,int $length){}
/** @return string */
function gzdeflate(string $data,int $level,int $encoding){}
/** @return string */
...
/** @return int */
function gzseek(resource $zp,int $offset,int $whence){}
/** @return int */
...
/** @return string */
function hash_file(string $algo,string $filename,bool $raw_output){}
/** @return string */
function hash_final(resource $context,bool $raw_output){}
/** @return string */
function hash_hmac_file(string $algo,string $filename,string $key,bool $raw_output){}
/** @return string */
function hash_hmac(string $algo,string $data,string $key,bool $raw_output){}
/** @return resource */
function hash_init(string $algo,int $options,string $key){}
/** @return string */
function hash_pbkdf2(string $algo,string $password,string $salt,int $iterations,int $length,bool $raw_output){}
/** @return string */
function hash(string $algo,string $data,bool $raw_output){}
/** @return bool */
function hash_update(resource $context,string $data){}
/** @return bool */
function hash_update_file(resource $hcontext,string $filename,resource $scontext){}
/** @return int */
function hash_update_stream(resource $context,resource $handle,int $length){}
/** @return bool */
...
/** @return bool */
function headers_sent(string &$file,int &$line){}
/** @return void */
...
/** @return mixed */
function highlight_file(string $filename,bool $return){}
/** @return mixed */
function highlight_string(string $str,bool $return){}
/** @return string */
function htmlentities(string $string,int $flags,string $encoding,bool $double_encode){}
/** @return string */
...
/** @return string */
function htmlspecialchars(string $string,int $flags,string $encoding,bool $double_encode){}
/** @return string */
function http_build_cookie(array $cookie){}
/** @return string */
function http_build_query(mixed $query_data,string $numeric_prefix,string $arg_separator,int $enc_type){}
/** @return string */
function http_build_str(array $query,string $prefix,string $arg_separator){}
/** @return string */
function http_build_url(mixed $url,mixed $parts,int $flags,array &$new_url){}
/** @return bool */
function http_cache_etag(string $etag){}
/** @return bool */
function http_cache_last_modified(int $timestamp_or_expires){}
/** @return string */
function http_chunked_decode(string $encoded){}
/** @return string */
function http_date(int $timestamp){}
/** @return string */
function http_deflate(string $data,int $flags){}
/** @return resource */
...
/** @return string */
function http_get(string $url,array $options,array &$info){}
/** @return string */
function http_head(string $url,array $options,array &$info){}
/** @return string */
function http_inflate(string $data){}
/** @return bool */
function http_match_etag(string $etag,bool $for_range){}
/** @return bool */
function http_match_modified(int $timestamp,bool $for_range){}
/** @return bool */
function http_match_request_header(string $header,string $value,bool $match_case){}
/** @return string */
function http_negotiate_charset(array $supported,array &$result){}
/** @return string */
function http_negotiate_content_type(array $supported,array &$result){}
/** @return string */
function http_negotiate_language(array $supported,array &$result){}
/** @return object */
function http_parse_cookie(string $cookie,int $flags,array $allowed_extras){}
/** @return array */
function http_parse_headers(string $header){}
/** @return object */
function http_parse_message(string $message){}
/** @return object */
function http_parse_params(string $param,int $flags){}
/** @return string */
function http_persistent_handles_clean(string $ident){}
/** @return object */
function http_persistent_handles_count(){}
/** @return string */
function http_persistent_handles_ident(string $ident){}
/** @return string */
function http_post_data(string $url,string $data,array $options,array &$info){}
/** @return string */
function http_post_fields(string $url,array $data,array $files,array $options,array &$info){}
/** @return string */
function http_put_data(string $url,string $data,array $options,array &$info){}
/** @return string */
function http_put_file(string $url,string $file,array $options,array &$info){}
/** @return string */
function http_put_stream(string $url,resource $stream,array $options,array &$info){}
/** @return bool */
function http_redirect(string $url,array $params,bool $session,int $status){}
/** @return string */
function http_request_body_encode(array $fields,array $files){}
/** @return int */
function http_request_method_exists(mixed $method){}
/** @return string */
function http_request_method_name(int $method){}
/** @return int */
function http_request_method_register(string $method){}
/** @return bool */
function http_request_method_unregister(mixed $method){}
/** @return string */
function http_request(int $method,string $url,string $body,array $options,array &$info){}
/** @return int */
function http_response_code(int $response_code){}
/** @return bool */
function http_send_content_disposition(string $filename,bool $inline){}
/** @return bool */
function http_send_content_type(string $content_type){}
/** @return bool */
function http_send_data(string $data){}
/** @return bool */
function http_send_file(string $file){}
/** @return bool */
function http_send_last_modified(int $timestamp){}
/** @return bool */
function http_send_status(int $status){}
/** @return bool */
function http_send_stream(resource $stream){}
/** @return int */
function http_support(int $feature){}
/** @return void */
function http_throttle(float $sec,int $bytes){}
/** @return HW_API_Attribute */
function hwapi_attribute_new(string $name,string $value){}
/** @return HW_API_Content */
function hwapi_content_new(string $content,string $mimetype){}
/** @return HW_API */
function hwapi_hgcsp(string $hostname,int $port){}
/** @return hw_api_object */
function hwapi_object_new(array $parameter){}
/** @return float */
function hypot(float $x,float $y){}
/** @return bool */
function ibase_add_user(resource $service_handle,string $user_name,string $password,string $first_name,string $middle_name,string $last_name){}
/** @return int */
function ibase_affected_rows(resource $link_identifier){}
/** @return mixed */
function ibase_backup(resource $service_handle,string $source_db,string $dest_file,int $options,bool $verbose){}
/** @return void */
...
/** @return array */
function ibase_blob_info(resource $link_identifier,string $blob_id){}
/** @return resource */
function ibase_blob_open(resource $link_identifier,string $blob_id){}
/** @return bool */
function ibase_close(resource $connection_id){}
/** @return bool */
function ibase_commit(resource $link_or_trans_identifier){}
/** @return bool */
function ibase_commit_ret(resource $link_or_trans_identifier){}
/** @return resource */
...
/** @return string */
function ibase_db_info(resource $service_handle,string $db,int $action,int $argument){}
/** @return bool */
function ibase_delete_user(resource $service_handle,string $user_name){}
/** @return bool */
...
/** @return resource */
function ibase_execute(resource $query,mixed $bind_arg,mixed $__args__){}
/** @return array */
...
/** @return mixed */
function ibase_gen_id(string $generator,int $increment,resource $link_identifier){}
/** @return bool */
function ibase_maintain_db(resource $service_handle,string $db,int $action,int $argument){}
/** @return bool */
function ibase_modify_user(resource $service_handle,string $user_name,string $password,string $first_name,string $middle_name,string $last_name){}
/** @return bool */
...
/** @return mixed */
function ibase_restore(resource $service_handle,string $source_file,string $dest_db,int $options,bool $verbose){}
/** @return bool */
function ibase_rollback(resource $link_or_trans_identifier){}
/** @return bool */
function ibase_rollback_ret(resource $link_or_trans_identifier){}
/** @return string */
...
/** @return resource */
function ibase_set_event_handler(callable $event_handler,string $event_name1,string $event_name2,string $__args__){}
/** @return resource */
function ibase_trans(int $trans_args,resource $link_identifier){}
/** @return string */
function ibase_wait_event(string $event_name1,string $event_name2,string $__args__){}
/** @return mixed */
function iconv_get_encoding(string $type){}
/** @return array */
function iconv_mime_decode_headers(string $encoded_headers,int $mode,string $charset){}
/** @return string */
function iconv_mime_decode(string $encoded_header,int $mode,string $charset){}
/** @return string */
function iconv_mime_encode(string $field_name,string $field_value,array $preferences){}
/** @return bool */
...
/** @return string */
function id3_get_frame_long_name(string $frameId){}
/** @return string */
function id3_get_frame_short_name(string $frameId){}
/** @return int */
function id3_get_genre_id(string $genre){}
/** @return array */
function id3_get_genre_list(){}
/** @return string */
function id3_get_genre_name(int $genre_id){}
/** @return array */
function id3_get_tag(string $filename,int $version){}
/** @return int */
function id3_get_version(string $filename){}
/** @return bool */
function id3_remove_tag(string $filename,int $version){}
/** @return bool */
function id3_set_tag(string $filename,array $tag,int $version){}
/** @return int */
function idate(string $format,int $timestamp){}
/** @return string */
function idn_to_ascii(string $domain,int $options,int $variant,array &$idna_info){}
/** @return string */
function idn_to_utf8(string $domain,int $options,int $variant,array &$idna_info){}
/** @return int */
function ifx_affected_rows(resource $result_id){}
/** @return bool */
function ifx_blobinfile_mode(int $mode){}
/** @return bool */
function ifx_byteasvarchar(int $mode){}
/** @return bool */
function ifx_close(resource $link_identifier){}
/** @return resource */
...
/** @return bool */
function ifx_do(resource $result_id){}
/** @return string */
function ifx_errormsg(int $errorcode){}
/** @return string */
function ifx_error(resource $link_identifier){}
/** @return array */
function ifx_fetch_row(resource $result_id,mixed $position){}
/** @return array */
function ifx_fieldproperties(resource $result_id){}
/** @return array */
function ifx_fieldtypes(resource $result_id){}
/** @return bool */
function ifx_free_blob(int $bid){}
/** @return bool */
function ifx_free_char(int $bid){}
/** @return bool */
function ifx_free_result(resource $result_id){}
/** @return string */
function ifx_get_blob(int $bid){}
/** @return string */
function ifx_get_char(int $bid){}
/** @return array */
function ifx_getsqlca(resource $result_id){}
/** @return int */
function ifx_htmltbl_result(resource $result_id,string $html_table_options){}
/** @return bool */
function ifx_nullformat(int $mode){}
/** @return int */
function ifx_num_fields(resource $result_id){}
/** @return int */
function ifx_num_rows(resource $result_id){}
/** @return resource */
function ifx_pconnect(string $database,string $userid,string $password){}
/** @return resource */
function ifx_prepare(string $query,resource $link_identifier,int $cursor_def,mixed $blobidarray){}
/** @return resource */
function ifx_query(string $query,resource $link_identifier,int $cursor_type,mixed $blobidarray){}
/** @return bool */
...
/** @return int */
function ifxus_open_slob(int $bid,int $mode){}
/** @return string */
function ifxus_read_slob(int $bid,int $nbytes){}
/** @return int */
function ifxus_seek_slob(int $bid,int $mode,int $offset){}
/** @return int */
function ifxus_tell_slob(int $bid){}
/** @return int */
function ifxus_write_slob(int $bid,string $content){}
/** @return int */
function ignore_user_abort(string $value){}
/** @return int */
function iis_add_server(string $path,string $comment,string $server_ip,int $port,string $host_name,int $rights,int $start_server){}
/** @return int */
function iis_get_dir_security(int $server_instance,string $virtual_path){}
/** @return string */
function iis_get_script_map(int $server_instance,string $virtual_path,string $script_extension){}
/** @return int */
function iis_get_server_by_comment(string $comment){}
/** @return int */
function iis_get_server_by_path(string $path){}
/** @return int */
function iis_get_server_rights(int $server_instance,string $virtual_path){}
/** @return int */
function iis_get_service_state(string $service_id){}
/** @return int */
function iis_remove_server(int $server_instance){}
/** @return int */
function iis_set_app_settings(int $server_instance,string $virtual_path,string $application_scope){}
/** @return int */
function iis_set_dir_security(int $server_instance,string $virtual_path,int $directory_flags){}
/** @return int */
function iis_set_script_map(int $server_instance,string $virtual_path,string $script_extension,string $engine_path,int $allow_scripting){}
/** @return int */
function iis_set_server_rights(int $server_instance,string $virtual_path,int $directory_flags){}
/** @return int */
function iis_start_server(int $server_instance){}
/** @return int */
function iis_start_service(string $service_id){}
/** @return int */
function iis_stop_server(int $server_instance){}
/** @return int */
function iis_stop_service(string $service_id){}
/** @return int */
function image2wbmp(resource $image,string $filename,int $threshold){}
/** @return array */
function imageaffinematrixconcat(array $m1,array $m2){}
/** @return array */
function imageaffinematrixget(int $type,mixed $options){}
/** @return resource */
function imageaffine(resource $image,array $affine,array $clip){}
/** @return bool */
function imagealphablending(resource $image,bool $blendmode){}
/** @return bool */
function imageantialias(resource $image,bool $enabled){}
/** @return bool */
...
/** @return bool */
function imageconvolution(resource $image,array $matrix,float $div,float $offset){}
/** @return bool */
...
/** @return bool */
function imagecopyresampled(resource $dst_image,resource $src_image,int $dst_x,int $dst_y,int $src_x,int $src_y,int $dst_w,int $dst_h,int $src_w,int $src_h){}
/** @return bool */
function imagecopyresized(resource $dst_image,resource $src_image,int $dst_x,int $dst_y,int $src_x,int $src_y,int $dst_w,int $dst_h,int $src_w,int $src_h){}
/** @return resource */
...
/** @return resource */
function imagecropauto(resource $image,int $mode,float $threshold,int $color){}
/** @return resource */
function imagecrop(resource $image,array $rect){}
/** @return bool */
...
/** @return bool */
function imagefilter(resource $src_im,int $filtertype,int $arg1,int $arg2,int $arg3){}
/** @return bool */
function imageflip(resource $image,int $mode){}
/** @return int */
function imagefontheight(int $font){}
/** @return int */
function imagefontwidth(int $font){}
/** @return array */
function imageftbbox(float $size,float $angle,string $fontfile,string $text,array $extrainfo){}
/** @return array */
function imagefttext(resource $image,float $size,float $angle,int $x,int $y,int $color,string $fontfile,string $text,array $extrainfo){}
/** @return bool */
...
/** @return resource */
function imagegrabwindow(int $window_handle,int $client_area){}
/** @return int */
...
/** @return bool */
function imagepalettetotruecolor(resource $src){}
/** @return bool */
...
/** @return array */
function imagepsbbox(string $text,resource $font,int $size){}
/** @return bool */
function imagepsencodefont(resource $font_index,string $encodingfile){}
/** @return bool */
function imagepsextendfont(resource $font_index,float $extend){}
/** @return bool */
function imagepsfreefont(resource $font_index){}
/** @return resource */
function imagepsloadfont(string $filename){}
/** @return bool */
function imagepsslantfont(resource $font_index,float $slant){}
/** @return array */
function imagepstext(resource $image,string $text,resource $font_index,int $size,int $foreground,int $background,int $x,int $y,int $space,int $tightness,float $angle,int $antialias_steps){}
/** @return bool */
function imagerectangle(resource $image,int $x1,int $y1,int $x2,int $y2,int $col){}
/** @return resource */
function imagerotate(resource $image,float $angle,int $bgd_color,int $ignore_transparent){}
/** @return bool */
function imagesavealpha(resource $image,bool $saveflag){}
/** @return resource */
function imagescale(resource $image,int $new_width,int $new_height,int $mode){}
/** @return bool */
function imagesetbrush(resource $image,resource $brush){}
/** @return bool */
function imagesetinterpolation(resource $image,int $method){}
/** @return bool */
...
/** @return array */
function imagettftext(resource $image,float $size,float $angle,int $x,int $y,int $color,string $fontfile,string $text){}
/** @return int */
function imagetypes(){}
/** @return string */
function image_type_to_extension(int $imagetype,bool $include_dot){}
/** @return string */
function image_type_to_mime_type(int $imagetype){}
/** @return bool */
function imagewbmp(resource $image,string $filename,int $foreground){}
/** @return bool */
function imagewebp(resource $image,string $filename){}
/** @return bool */
function imagexbm(resource $image,string $filename,int $foreground){}
/** @return string */
function imap_8bit(string $string){}
/** @return array */
function imap_alerts(){}
/** @return bool */
function imap_append(resource $imap_stream,string $mailbox,string $message,string $options,string $internal_date){}
/** @return string */
...
/** @return bool */
function imap_clearflag_full(resource $imap_stream,string $sequence,string $flag,int $options){}
/** @return bool */
function imap_close(resource $imap_stream,int $flag){}
/** @return bool */
function imap_createmailbox(resource $imap_stream,string $mailbox){}
/** @return bool */
function imap_delete(resource $imap_stream,int $msg_number,int $options){}
/** @return bool */
...
/** @return string */
function imap_fetchbody(resource $imap_stream,int $msg_number,string $section,int $options){}
/** @return string */
function imap_fetchheader(resource $imap_stream,int $msg_number,int $options){}
/** @return string */
function imap_fetchmime(resource $imap_stream,int $msg_number,string $section,int $options){}
/** @return array */
...
/** @return bool */
function imap_mail_copy(resource $imap_stream,string $msglist,string $mailbox,int $options){}
/** @return bool */
function imap_mail_move(resource $imap_stream,string $msglist,string $mailbox,int $options){}
/** @return array */
...
/** @return resource */
function imap_open(string $mailbox,string $username,string $password,int $options,int $n_retries,array $params){}
/** @return bool */
...
/** @return bool */
function imap_reopen(resource $imap_stream,string $mailbox,int $options,int $n_retries){}
/** @return array */
...
/** @return bool */
function imap_savebody(resource $imap_stream,mixed $file,int $msg_number,string $part_number,int $options){}
/** @return array */
function imap_search(resource $imap_stream,string $criteria,int $options,string $charset){}
/** @return bool */
function imap_setacl(resource $imap_stream,string $mailbox,string $id,string $rights){}
/** @return bool */
function imap_setflag_full(resource $imap_stream,string $sequence,string $flag,int $options){}
/** @return bool */
function imap_set_quota(resource $imap_stream,string $quota_root,int $quota_limit){}
/** @return array */
function imap_sort(resource $imap_stream,int $criteria,int $reverse,int $options,string $search_criteria,string $charset){}
/** @return object */
...
/** @return array */
function imap_thread(resource $imap_stream,int $options){}
/** @return mixed */
function imap_timeout(int $timeout_type,int $timeout){}
/** @return int */
function imap_uid(resource $imap_stream,int $msg_number){}
/** @return bool */
function imap_undelete(resource $imap_stream,int $msg_number,int $flags){}
/** @return bool */
...
/** @return bool */
function ingres_autocommit_state(resource $link){}
/** @return string */
function ingres_charset(resource $link){}
/** @return bool */
...
/** @return string */
function ingres_cursor(resource $result){}
/** @return int */
function ingres_errno(resource $link){}
/** @return string */
function ingres_error(resource $link){}
/** @return string */
function ingres_errsqlstate(resource $link){}
/** @return string */
function ingres_escape_string(resource $link,string $source_string){}
/** @return bool */
function ingres_execute(resource $result,array $params,string $types){}
/** @return array */
function ingres_fetch_array(resource $result,int $result_type){}
/** @return array */
function ingres_fetch_assoc(resource $result){}
/** @return object */
function ingres_fetch_object(resource $result,int $result_type){}
/** @return int */
function ingres_fetch_proc_return(resource $result){}
/** @return array */
function ingres_fetch_row(resource $result){}
/** @return int */
function ingres_field_length(resource $result,int $index){}
/** @return string */
function ingres_field_name(resource $result,int $index){}
/** @return bool */
function ingres_field_nullable(resource $result,int $index){}
/** @return int */
function ingres_field_precision(resource $result,int $index){}
/** @return int */
function ingres_field_scale(resource $result,int $index){}
/** @return string */
function ingres_field_type(resource $result,int $index){}
/** @return bool */
function ingres_free_result(resource $result){}
/** @return bool */
function ingres_next_error(resource $link){}
/** @return int */
function ingres_num_fields(resource $result){}
/** @return int */
function ingres_num_rows(resource $result){}
/** @return resource */
function ingres_pconnect(string $database,string $username,string $password,array $options){}
/** @return mixed */
function ingres_prepare(resource $link,string $query){}
/** @return mixed */
function ingres_query(resource $link,string $query,array $params,string $types){}
/** @return bool */
function ingres_result_seek(resource $result,int $position){}
/** @return bool */
function ingres_rollback(resource $link){}
/** @return bool */
function ingres_set_environment(resource $link,array $options){}
/** @return mixed */
function ingres_unbuffered_query(resource $link,string $query,array $params,string $types){}
/** @return array */
...
/** @return int */
function inotify_add_watch(resource $inotify_instance,string $pathname,int $mask){}
/** @return resource */
function inotify_init(){}
/** @return int */
function inotify_queue_len(resource $inotify_instance){}
/** @return array */
function inotify_read(resource $inotify_instance){}
/** @return bool */
function inotify_rm_watch(resource $inotify_instance,int $watch_descriptor){}
/** @return bool */
function interface_exists(string $interface_name,bool $autoload){}
/** @return string */
...
/** @return bool */
function is_a(object $object,string $class_name,bool $allow_string){}
/** @return bool */
function is_array(mixed $var){}
/** @return bool */
function is_bool(mixed $var){}
/** @return bool */
function is_callable(callable $name,bool $syntax_only,string &$callable_name){}
/** @return bool */
...
/** @return bool */
//function isset(mixed $var,mixed $__args__){}
/** @return bool */
function is_soap_fault(mixed $object){}
/** @return bool */
function is_string(mixed $var){}
/** @return bool */
function is_subclass_of(object $object,string $class_name){}
/** @return bool */
...
/** @return int */
function iterator_apply(Traversable $iterator,callable $function,array $args){}
/** @return int */
function iterator_count(Traversable $iterator){}
/** @return array */
function iterator_to_array(Traversable $iterator,bool $use_keys){}
/** @return mixed */
...
/** @return string */
function jdtojewish(int $juliandaycount,bool $hebrew,int $fl){}
/** @return string */
...
/** @return mixed */
function json_decode(string $json,bool $assoc,int $depth,int $options){}
/** @return string */
function json_encode(mixed $value,int $options){}
/** @return int */
function json_last_error(){}
/** @return string */
function json_last_error_msg(){}
/** @return int */
function judy_type(Judy $array){}
/** @return string */
function judy_version(){}
/** @return int */
function juliantojd(int $month,int $day,int $year){}
/** @return bool */
function kadm5_chpass_principal(resource $handle,string $principal,string $password){}
/** @return bool */
function kadm5_create_principal(resource $handle,string $principal,string $password,array $options){}
/** @return bool */
function kadm5_delete_principal(resource $handle,string $principal){}
/** @return bool */
function kadm5_destroy(resource $handle){}
/** @return bool */
function kadm5_flush(resource $handle){}
/** @return array */
function kadm5_get_policies(resource $handle){}
/** @return array */
function kadm5_get_principal(resource $handle,string $principal){}
/** @return array */
function kadm5_get_principals(resource $handle){}
/** @return resource */
function kadm5_init_with_password(string $admin_server,string $realm,string $principal,string $password){}
/** @return bool */
function kadm5_modify_principal(resource $handle,string $principal,array $options){}
/** @return mixed */
...
function lcg_value(){}
/** @return bool */
function lchgrp(string $filename,mixed $group){}
/** @return bool */
function lchown(string $filename,mixed $user){}
/** @return string */
...
/** @return bool */
function ldap_control_paged_result(resource $link,int $pagesize,bool $iscritical,string $cookie){}
/** @return bool */
function ldap_control_paged_result_response(resource $link,resource $result,string &$cookie,int &$estimated){}
/** @return int */
...
/** @return string */
function ldap_escape(string $value,string $ignore,int $flags){}
/** @return array */
function ldap_explode_dn(string $dn,int $with_attrib){}
/** @return string */
function ldap_first_attribute(resource $link_identifier,resource $result_entry_identifier){}
/** @return resource */
...
/** @return bool */
function ldap_modify_batch(resource $link_identifier,string $dn,array $entry){}
/** @return bool */
...
/** @return bool */
function ldap_sasl_bind(resource $link,string $binddn,string $password,string $sasl_mech,string $sasl_realm,string $sasl_authc_id,string $sasl_authz_id,string $props){}
/** @return resource */
...
/** @return bool */
function ldap_set_rebind_proc(resource $link,callable $callback){}
/** @return bool */
...
/** @return bool */
function libxml_disable_entity_loader(bool $disable){}
/** @return array */
...
/** @return bool */
function libxml_use_internal_errors(bool $use_errors){}
/** @return bool */
function link(string $target,string $link){}
/** @return int */
function linkinfo(string $path){}
/** @return array */
//function list(mixed $varname,mixed $__args__){}
/** @return array */
function localeconv(){}
/** @return array */
...
/** @return string */
function mailparse_msg_extract_part_file(resource $mimemail,mixed $filename,callable $callbackfunc){}
/** @return void */
function mailparse_msg_extract_part(resource $mimemail,string $msgbody,callable $callbackfunc){}
/** @return string */
function mailparse_msg_extract_whole_part_file(resource $mimemail,string $filename,callable $callbackfunc){}
/** @return bool */
...
/** @return int */
function maxdb_affected_rows(resource $link){}
/** @return bool */
function maxdb_autocommit(resource $link,bool $mode){}
/** @return bool */
function maxdb_change_user(resource $link,string $user,string $password,string $database){}
/** @return string */
function maxdb_character_set_name(resource $link){}
/** @return bool */
function maxdb_close(resource $link){}
/** @return bool */
function maxdb_commit(resource $link){}
/** @return int */
function maxdb_connect_errno(){}
/** @return string */
function maxdb_connect_error(){}
/** @return resource */
function maxdb_connect(string $host,string $username,string $passwd,string $dbname,int $port,string $socket){}
/** @return bool */
function maxdb_data_seek(resource $result,int $offset){}
/** @return void */
function maxdb_debug(string $debug){}
/** @return bool */
function maxdb_disable_reads_from_master(resource $link){}
/** @return bool */
function maxdb_disable_rpl_parse(resource $link){}
/** @return bool */
function maxdb_dump_debug_info(resource $link){}
/** @return resource */
function maxdb_embedded_connect(string $dbname){}
/** @return bool */
function maxdb_enable_reads_from_master(resource $link){}
/** @return bool */
function maxdb_enable_rpl_parse(resource $link){}
/** @return int */
function maxdb_errno(resource $link){}
/** @return string */
function maxdb_error(resource $link){}
/** @return mixed */
function maxdb_fetch_array(resource $result,int $resulttype){}
/** @return array */
function maxdb_fetch_assoc(resource $result){}
/** @return mixed */
function maxdb_fetch_field_direct(resource $result,int $fieldnr){}
/** @return mixed */
function maxdb_fetch_field(resource $result){}
/** @return mixed */
function maxdb_fetch_fields(resource $result){}
/** @return array */
function maxdb_fetch_lengths(resource $result){}
/** @return object */
function maxdb_fetch_object(object $result){}
/** @return mixed */
function maxdb_fetch_row(resource $result){}
/** @return int */
function maxdb_field_count(resource $link){}
/** @return bool */
function maxdb_field_seek(resource $result,int $fieldnr){}
/** @return int */
function maxdb_field_tell(resource $result){}
/** @return void */
function maxdb_free_result(resource $result){}
/** @return string */
function maxdb_get_client_info(){}
/** @return int */
function maxdb_get_client_version(){}
/** @return string */
function maxdb_get_host_info(resource $link){}
/** @return int */
function maxdb_get_proto_info(resource $link){}
/** @return string */
function maxdb_get_server_info(resource $link){}
/** @return int */
function maxdb_get_server_version(resource $link){}
/** @return string */
function maxdb_info(resource $link){}
/** @return resource */
function maxdb_init(){}
/** @return mixed */
function maxdb_insert_id(resource $link){}
/** @return bool */
function maxdb_kill(resource $link,int $processid){}
/** @return bool */
function maxdb_master_query(resource $link,string $query){}
/** @return bool */
function maxdb_more_results(resource $link){}
/** @return bool */
function maxdb_multi_query(resource $link,string $query){}
/** @return bool */
function maxdb_next_result(resource $link){}
/** @return int */
function maxdb_num_fields(resource $result){}
/** @return int */
function maxdb_num_rows(resource $result){}
/** @return bool */
function maxdb_options(resource $link,int $option,mixed $value){}
/** @return bool */
function maxdb_ping(resource $link){}
/** @return resource */
function maxdb_prepare(resource $link,string $query){}
/** @return mixed */
function maxdb_query(resource $link,string $query,int $resultmode){}
/** @return bool */
function maxdb_real_connect(resource $link,string $hostname,string $username,string $passwd,string $dbname,int $port,string $socket){}
/** @return string */
function maxdb_real_escape_string(resource $link,string $escapestr){}
/** @return bool */
function maxdb_real_query(resource $link,string $query){}
/** @return bool */
function maxdb_report(int $flags){}
/** @return bool */
function maxdb_rollback(resource $link){}
/** @return int */
function maxdb_rpl_parse_enabled(resource $link){}
/** @return bool */
function maxdb_rpl_probe(resource $link){}
/** @return int */
function maxdb_rpl_query_type(resource $link){}
/** @return bool */
function maxdb_select_db(resource $link,string $dbname){}
/** @return bool */
function maxdb_send_query(resource $link,string $query){}
/** @return void */
function maxdb_server_end(){}
/** @return bool */
function maxdb_server_init(array $server,array $groups){}
/** @return string */
function maxdb_sqlstate(resource $link){}
/** @return bool */
function maxdb_ssl_set(resource $link,string $key,string $cert,string $ca,string $capath,string $cipher){}
/** @return string */
function maxdb_stat(resource $link){}
/** @return int */
function maxdb_stmt_affected_rows(resource $stmt){}
/** @return bool */
function maxdb_stmt_bind_param(resource $stmt,string $types,mixed &$var1,mixed &$__args__){}
/** @return bool */
function maxdb_stmt_bind_result(resource $stmt,mixed &$var1,mixed &$__args__){}
/** @return bool */
function maxdb_stmt_close(resource $stmt){}
/** @return bool */
function maxdb_stmt_close_long_data(resource $stmt,int $param_nr){}
/** @return bool */
function maxdb_stmt_data_seek(resource $statement,int $offset){}
/** @return int */
function maxdb_stmt_errno(resource $stmt){}
/** @return string */
function maxdb_stmt_error(resource $stmt){}
/** @return bool */
function maxdb_stmt_execute(resource $stmt){}
/** @return bool */
function maxdb_stmt_fetch(resource $stmt){}
/** @return void */
function maxdb_stmt_free_result(resource $stmt){}
/** @return resource */
function maxdb_stmt_init(resource $link){}
/** @return int */
function maxdb_stmt_num_rows(resource $stmt){}
/** @return int */
function maxdb_stmt_param_count(resource $stmt){}
/** @return bool */
function maxdb_stmt_prepare(resource $stmt,string $query){}
/** @return bool */
function maxdb_stmt_reset(resource $stmt){}
/** @return resource */
function maxdb_stmt_result_metadata(resource $stmt){}
/** @return bool */
function maxdb_stmt_send_long_data(resource $stmt,int $param_nr,string $data){}
/** @return string */
function maxdb_stmt_sqlstate(resource $stmt){}
/** @return bool */
function maxdb_stmt_store_result(resource $stmt){}
/** @return resource */
function maxdb_store_result(resource $link){}
/** @return int */
function maxdb_thread_id(resource $link){}
/** @return bool */
function maxdb_thread_safe(){}
/** @return resource */
function maxdb_use_result(resource $link){}
/** @return int */
function maxdb_warning_count(resource $link){}
/** @return mixed */
function max(array $values){}
/** @return bool */
function mb_check_encoding(string $var,string $encoding){}
/** @return string */
function mb_convert_case(string $str,int $mode,string $encoding){}
/** @return string */
function mb_convert_encoding(string $str,string $to_encoding,mixed $from_encoding){}
/** @return string */
function mb_convert_kana(string $str,string $option,string $encoding){}
/** @return string */
function mb_convert_variables(string $to_encoding,mixed $from_encoding,mixed &$vars,mixed &$__args__){}
/** @return string */
function mb_decode_mimeheader(string $str){}
/** @return string */
function mb_decode_numericentity(string $str,array $convmap,string $encoding){}
/** @return string */
function mb_detect_encoding(string $str,mixed $encoding_list,bool $strict){}
/** @return mixed */
function mb_detect_order(mixed $encoding_list){}
/** @return string */
function mb_encode_mimeheader(string $str,string $charset,string $transfer_encoding,string $linefeed,int $indent){}
/** @return string */
function mb_encode_numericentity(string $str,array $convmap,string $encoding,bool $is_hex){}
/** @return array */
...
/** @return string */
function mb_eregi_replace(string $pattern,string $replace,string $string,string $option){}
/** @return bool */
function mb_ereg_match(string $pattern,string $string,string $option){}
/** @return string */
function mb_ereg_replace_callback(string $pattern,callable $callback,string $string,string $option){}
/** @return string */
function mb_ereg_replace(string $pattern,string $replacement,string $string,string $option){}
/** @return bool */
...
/** @return int */
function mb_stripos(string $haystack,string $needle,int $offset,string $encoding){}
/** @return string */
function mb_stristr(string $haystack,string $needle,bool $before_needle,string $encoding){}
/** @return mixed */
function mb_strlen(string $str,string $encoding){}
/** @return int */
function mb_strpos(string $haystack,string $needle,int $offset,string $encoding){}
/** @return string */
function mb_strrchr(string $haystack,string $needle,bool $part,string $encoding){}
/** @return string */
function mb_strrichr(string $haystack,string $needle,bool $part,string $encoding){}
/** @return int */
function mb_strripos(string $haystack,string $needle,int $offset,string $encoding){}
/** @return int */
function mb_strrpos(string $haystack,string $needle,int $offset,string $encoding){}
/** @return string */
function mb_strstr(string $haystack,string $needle,bool $before_needle,string $encoding){}
/** @return string */
...
/** @return int */
function m_checkstatus(resource $conn,int $identifier){}
/** @return int */
function m_completeauthorizations(resource $conn,int &$array){}
/** @return int */
function m_connect(resource $conn){}
/** @return string */
function m_connectionerror(resource $conn){}
/** @return string */
...
/** @return string */
function md5(string $str,bool $raw_output){}
/** @return string */
function mdecrypt_generic(resource $td,string $data){}
/** @return bool */
function m_deletetrans(resource $conn,int $identifier){}
/** @return bool */
function m_destroyconn(resource $conn){}
/** @return void */
function m_destroyengine(){}
/** @return bool */
function memcache_debug(bool $on_off){}
/** @return int */
function memory_get_peak_usage(bool $real_usage){}
/** @return int */
function memory_get_usage(bool $real_usage){}
/** @return string */
function metaphone(string $str,int $phonemes){}
/** @return bool */
function method_exists(mixed $object,string $method_name){}
/** @return string */
function m_getcellbynum(resource $conn,int $identifier,int $column,int $row){}
/** @return string */
function m_getcell(resource $conn,int $identifier,string $column,int $row){}
/** @return string */
function m_getcommadelimited(resource $conn,int $identifier){}
/** @return string */
function m_getheader(resource $conn,int $identifier,int $column_num){}
/** @return int */
...
/** @return mixed */
function microtime(bool $get_as_float){}
/** @return string */
function mime_content_type(string $filename){}
/** @return int */
function ming_keypress(string $char){}
/** @return void */
...
function m_initconn(){}
/** @return int */
function m_initengine(string $location){}
/** @return mixed */
function min(array $values){}
/** @return int */
function m_iscommadelimited(resource $conn,int $identifier){}
/** @return bool */
function mkdir(string $pathname,int $mode,bool $recursive,resource $context){}
/** @return int */
function mktime(int $hour,int $minute,int $second,int $month,int $day,int $year,int $is_dst){}
/** @return bool */
function m_maxconntimeout(resource $conn,int $secs){}
/** @return int */
function m_monitor(resource $conn){}
/** @return int */
function m_numcolumns(resource $conn,int $identifier){}
/** @return int */
function m_numrows(resource $conn,int $identifier){}
/** @return string */
function money_format(string $format,float $number){}
/** @return bool */
function move_uploaded_file(string $filename,string $destination){}
/** @return int */
function m_parsecommadelimited(resource $conn,int $identifier){}
/** @return void */
function mqseries_back(resource $hconn,resource &$compCode,resource &$reason){}
/** @return void */
function mqseries_begin(resource $hconn,array $beginOptions,resource &$compCode,resource &$reason){}
/** @return void */
function mqseries_close(resource $hconn,resource $hobj,int $options,resource &$compCode,resource &$reason){}
/** @return void */
function mqseries_cmit(resource $hconn,resource &$compCode,resource &$reason){}
/** @return void */
function mqseries_conn(string $qManagerName,resource &$hconn,resource &$compCode,resource &$reason){}
/** @return void */
function mqseries_connx(string $qManagerName,array &$connOptions,resource &$hconn,resource &$compCode,resource &$reason){}
/** @return void */
function mqseries_disc(resource $hconn,resource &$compCode,resource &$reason){}
/** @return void */
function mqseries_get(resource $hConn,resource $hObj,array &$md,array &$gmo,int &$bufferLength,string &$msg,int &$data_length,resource &$compCode,resource &$reason){}
/** @return void */
function mqseries_inq(resource $hconn,resource $hobj,int $selectorCount,array $selectors,int $intAttrCount,resource &$intAttr,int $charAttrLength,resource &$charAttr,resource &$compCode,resource &$reason){}
/** @return void */
function mqseries_open(resource $hconn,array &$objDesc,int $option,resource &$hobj,resource &$compCode,resource &$reason){}
/** @return void */
function mqseries_put1(resource $hconn,resource &$objDesc,resource &$msgDesc,resource &$pmo,string $buffer,resource &$compCode,resource &$reason){}
/** @return void */
function mqseries_put(resource $hConn,resource $hObj,array &$md,array &$pmo,string $message,resource &$compCode,resource &$reason){}
/** @return void */
function mqseries_set(resource $hconn,resource $hobj,int $selectorcount,array $selectors,int $intattrcount,array $intattrs,int $charattrlength,array $charattrs,resource &$compCode,resource &$reason){}
/** @return string */
function mqseries_strerror(int $reason){}
/** @return array */
function m_responsekeys(resource $conn,int $identifier){}
/** @return string */
function m_responseparam(resource $conn,int $identifier,string $key){}
/** @return int */
function m_returnstatus(resource $conn,int $identifier){}
/** @return bool */
function msession_connect(string $host,string $port){}
/** @return int */
function msession_count(){}
/** @return bool */
function msession_create(string $session,string $classname,string $data){}
/** @return bool */
...
/** @return string */
function msession_get_data(string $session){}
/** @return string */
...
/** @return bool */
function msession_set_data(string $session,string $value){}
/** @return int */
function msession_timeout(string $session,int $param){}
/** @return string */
function msession_uniq(int $param,string $classname,string $data){}
/** @return int */
function msession_unlock(string $session,int $key){}
/** @return int */
function m_setblocking(resource $conn,int $tf){}
/** @return int */
function m_setdropfile(resource $conn,string $directory){}
/** @return int */
function m_setip(resource $conn,string $host,int $port){}
/** @return int */
function m_setssl_cafile(resource $conn,string $cafile){}
/** @return int */
function m_setssl_files(resource $conn,string $sslkeyfile,string $sslcertfile){}
/** @return int */
function m_setssl(resource $conn,string $host,int $port){}
/** @return int */
function m_settimeout(resource $conn,int $seconds){}
/** @return resource */
function msg_get_queue(int $key,int $perms){}
/** @return bool */
function msg_queue_exists(int $key){}
/** @return bool */
function msg_receive(resource $queue,int $desiredmsgtype,int &$msgtype,int $maxsize,mixed &$message,bool $unserialize,int $flags,int &$errorcode){}
/** @return bool */
function msg_remove_queue(resource $queue){}
/** @return bool */
function msg_send(resource $queue,int $msgtype,mixed $message,bool $serialize,bool $blocking,int &$errorcode){}
/** @return bool */
function msg_set_queue(resource $queue,array $data){}
/** @return array */
function msg_stat_queue(resource $queue){}
/** @return int */
function msql_affected_rows(resource $result){}
/** @return bool */
function msql_close(resource $link_identifier){}
/** @return resource */
function msql_connect(string $hostname){}
/** @return bool */
function msql_create_db(string $database_name,resource $link_identifier){}
/** @return bool */
function msql_data_seek(resource $result,int $row_number){}
/** @return resource */
function msql_db_query(string $database,string $query,resource $link_identifier){}
/** @return bool */
function msql_drop_db(string $database_name,resource $link_identifier){}
/** @return string */
function msql_error(){}
/** @return array */
function msql_fetch_array(resource $result,int $result_type){}
/** @return object */
function msql_fetch_field(resource $result,int $field_offset){}
/** @return object */
function msql_fetch_object(resource $result){}
/** @return array */
function msql_fetch_row(resource $result){}
/** @return string */
function msql_field_flags(resource $result,int $field_offset){}
/** @return int */
function msql_field_len(resource $result,int $field_offset){}
/** @return string */
function msql_field_name(resource $result,int $field_offset){}
/** @return bool */
function msql_field_seek(resource $result,int $field_offset){}
/** @return int */
function msql_field_table(resource $result,int $field_offset){}
/** @return string */
function msql_field_type(resource $result,int $field_offset){}
/** @return bool */
function msql_free_result(resource $result){}
/** @return resource */
function msql_list_dbs(resource $link_identifier){}
/** @return resource */
function msql_list_fields(string $database,string $tablename,resource $link_identifier){}
/** @return resource */
function msql_list_tables(string $database,resource $link_identifier){}
/** @return int */
function msql_num_fields(resource $result){}
/** @return int */
function msql_num_rows(resource $query_identifier){}
/** @return resource */
function msql_pconnect(string $hostname){}
/** @return resource */
function msql_query(string $query,resource $link_identifier){}
/** @return string */
function msql_result(resource $result,int $row,mixed $field){}
/** @return bool */
function msql_select_db(string $database_name,resource $link_identifier){}
/** @return string */
function m_sslcert_gen_hash(string $filename){}
/** @return bool */
function mssql_bind(resource $stmt,string $param_name,mixed &$var,int $type,bool $is_output,bool $is_null,int $maxlen){}
/** @return bool */
function mssql_close(resource $link_identifier){}
/** @return resource */
function mssql_connect(string $servername,string $username,string $password,bool $new_link){}
/** @return bool */
...
/** @return int */
function mssql_fetch_batch(resource $result){}
/** @return object */
...
/** @return bool */
function mssql_free_statement(resource $stmt){}
/** @return string */
function mssql_get_last_message(){}
/** @return string */
function mssql_guid_string(string $binary,bool $short_format){}
/** @return resource */
function mssql_init(string $sp_name,resource $link_identifier){}
/** @return void */
...
/** @return resource */
function mssql_pconnect(string $servername,string $username,string $password,bool $new_link){}
/** @return mixed */
function mssql_query(string $query,resource $link_identifier,int $batch_size){}
/** @return string */
function mssql_result(resource $result,int $row,mixed $field){}
/** @return int */
function mssql_rows_affected(resource $link_identifier){}
/** @return bool */
...
function mt_rand(){}
/** @return int */
function m_transactionssent(resource $conn){}
/** @return int */
function m_transinqueue(resource $conn){}
/** @return int */
function m_transkeyval(resource $conn,int $identifier,string $key,string $value){}
/** @return int */
function m_transnew(resource $conn){}
/** @return int */
function m_transsend(resource $conn,int $identifier){}
/** @return void */
function mt_srand(int $seed){}
/** @return int */
function m_uwait(int $microsecs){}
/** @return int */
function m_validateidentifier(resource $conn,int $tf){}
/** @return bool */
function m_verifyconnection(resource $conn,int $tf){}
/** @return bool */
function m_verifysslcert(resource $conn,int $tf){}
/** @return int */
...
/** @return object */
function mysql_fetch_object(resource $result){}
/** @return array */
...
/** @return string */
function mysql_field_name(resource $result,int $field_index){}
/** @return int */
...
/** @return bool */
function mysqli_master_query(mysqli $link,string $query){}
/** @return string */
...
/** @return bool */
function mysqli_slave_query(mysqli $link,string $query){}
/** @return resource */
...
/** @return array */
function mysqlnd_memcache_get_config(mixed $connection){}
/** @return bool */
function mysqlnd_memcache_set(mixed $mysql_connection,Memcached $memcache_connection,string $pattern,callback $callback){}
/** @return array */
function mysqlnd_ms_dump_servers(mixed $connection){}
/** @return array */
function mysqlnd_ms_fabric_select_global(mixed $connection,mixed $table_name){}
/** @return array */
function mysqlnd_ms_fabric_select_shard(mixed $connection,mixed $table_name,mixed $shard_key){}
/** @return string */
function mysqlnd_ms_get_last_gtid(mixed $connection){}
/** @return array */
function mysqlnd_ms_get_last_used_connection(mixed $connection){}
/** @return array */
function mysqlnd_ms_get_stats(){}
/** @return bool */
function mysqlnd_ms_match_wild(string $table_name,string $wildcard){}
/** @return int */
function mysqlnd_ms_query_is_select(string $query){}
/** @return bool */
function mysqlnd_ms_set_qos(mixed $connection,int $service_level,int $service_level_option,mixed $option_value){}
/** @return bool */
function mysqlnd_ms_set_user_pick_server(string $function){}
/** @return int */
function mysqlnd_ms_xa_begin(mixed $connection,string $gtrid,int $timeout){}
/** @return int */
function mysqlnd_ms_xa_commit(mixed $connection,string $gtrid){}
/** @return int */
function mysqlnd_ms_xa_gc(mixed $connection,string $gtrid,boolean $ignore_max_retries){}
/** @return int */
function mysqlnd_ms_xa_rollback(mixed $connection,string $gtrid){}
/** @return bool */
...
/** @return bool */
function mysqlnd_qc_set_cache_condition(int $condition_type,mixed $condition,mixed $condition_option){}
/** @return mixed */
function mysqlnd_qc_set_is_select(string $callback){}
/** @return bool */
function mysqlnd_qc_set_storage_handler(string $handler){}
/** @return bool */
function mysqlnd_qc_set_user_handlers(string $get_hash,string $find_query_in_cache,string $return_to_cache,string $add_query_to_cache_if_not_exists,string $query_is_select,string $update_query_run_time_stats,string $get_stats,string $clear_cache){}
/** @return resource */
function mysqlnd_uh_convert_to_mysqlnd(mysqli &$mysql_connection){}
/** @return bool */
function mysqlnd_uh_set_connection_proxy(MysqlndUhConnection &$connection_proxy,mysqli &$mysqli_connection){}
/** @return bool */
function mysqlnd_uh_set_statement_proxy(MysqlndUhStatement &$statement_proxy){}
/** @return int */
...
/** @return int */
function ncurses_meta(resource $window,bool $bit8 ){}
/** @return int */
...
/** @return int */
function newt_centered_window(int $width,int $height,string $title){}
/** @return string */
function newt_checkbox_get_value(resource $checkbox){}
/** @return resource */
function newt_checkbox(int $left,int $top,string $text,string $def_value,string $seq){}
/** @return void */
function newt_checkbox_set_flags(resource $checkbox,int $flags,int $sense){}
/** @return void */
function newt_checkbox_set_value(resource $checkbox,string $value){}
/** @return void */
function newt_checkbox_tree_add_item(resource $checkboxtree,string $text,mixed $data,int $flags,int $index,int $__args__){}
/** @return array */
function newt_checkbox_tree_find_item(resource $checkboxtree,mixed $data){}
/** @return mixed */
function newt_checkbox_tree_get_current(resource $checkboxtree){}
/** @return string */
function newt_checkbox_tree_get_entry_value(resource $checkboxtree,mixed $data){}
/** @return array */
function newt_checkbox_tree_get_multi_selection(resource $checkboxtree,string $seqnum){}
/** @return array */
function newt_checkbox_tree_get_selection(resource $checkboxtree){}
/** @return resource */
function newt_checkbox_tree_multi(int $left,int $top,int $height,string $seq,int $flags){}
/** @return resource */
function newt_checkbox_tree(int $left,int $top,int $height,int $flags){}
/** @return void */
function newt_checkbox_tree_set_current(resource $checkboxtree,mixed $data){}
/** @return void */
function newt_checkbox_tree_set_entry_value(resource $checkboxtree,mixed $data,string $value){}
/** @return void */
function newt_checkbox_tree_set_entry(resource $checkboxtree,mixed $data,string $text){}
/** @return void */
function newt_checkbox_tree_set_width(resource $checkbox_tree,int $width){}
/** @return void */
...
/** @return void */
function newt_component_add_callback(resource $component,mixed $func_name,mixed $data){}
/** @return void */
function newt_component_takes_focus(resource $component,bool $takes_focus){}
/** @return resource */
...
/** @return void */
function newt_draw_form(resource $form){}
/** @return void */
function newt_draw_root_text(int $left,int $top,string $text){}
/** @return string */
function newt_entry_get_value(resource $entry){}
/** @return resource */
function newt_entry(int $left,int $top,int $width,string $init_value,int $flags){}
/** @return void */
function newt_entry_set_filter(resource $entry,callable $filter,mixed $data){}
/** @return void */
function newt_entry_set_flags(resource $entry,int $flags,int $sense){}
/** @return void */
function newt_entry_set(resource $entry,string $value,bool $cursor_at_end){}
/** @return int */
function newt_finished(){}
/** @return void */
function newt_form_add_components(resource $form,array $components){}
/** @return void */
function newt_form_add_component(resource $form,resource $component){}
/** @return void */
function newt_form_add_hot_key(resource $form,int $key){}
/** @return void */
function newt_form_destroy(resource $form){}
/** @return resource */
function newt_form_get_current(resource $form){}
/** @return resource */
function newt_form(resource $vert_bar,string $help,int $flags){}
/** @return void */
function newt_form_run(resource $form,array &$exit_struct){}
/** @return void */
function newt_form_set_background(resource $from,int $background){}
/** @return void */
function newt_form_set_height(resource $form,int $height){}
/** @return void */
function newt_form_set_size(resource $form){}
/** @return void */
function newt_form_set_timer(resource $form,int $milliseconds){}
/** @return void */
function newt_form_set_width(resource $form,int $width){}
/** @return void */
function newt_form_watch_fd(resource $form,resource $stream,int $flags){}
/** @return void */
function newt_get_screen_size(int &$cols,int &$rows){}
/** @return void */
function newt_grid_add_components_to_form(resource $grid,resource $form,bool $recurse){}
/** @return resource */
function newt_grid_basic_window(resource $text,resource $middle,resource $buttons){}
/** @return void */
function newt_grid_free(resource $grid,bool $recurse){}
/** @return void */
function newt_grid_get_size(resouce $grid,int &$width,int &$height){}
/** @return resource */
function newt_grid_h_close_stacked(int $element1_type,resource $element1,int $__args__,resource $__args__){}
/** @return resource */
function newt_grid_h_stacked(int $element1_type,resource $element1,int $__args__,resource $__args__){}
/** @return void */
function newt_grid_place(resource $grid,int $left,int $top){}
/** @return void */
function newt_grid_set_field(resource $grid,int $col,int $row,int $type,resource $val,int $pad_left,int $pad_top,int $pad_right,int $pad_bottom,int $anchor,int $flags){}
/** @return resource */
function newt_grid_simple_window(resource $text,resource $middle,resource $buttons){}
/** @return resource */
function newt_grid_v_close_stacked(int $element1_type,resource $element1,int $__args__,resource $__args__){}
/** @return resource */
function newt_grid_v_stacked(int $element1_type,resource $element1,int $__args__,resource $__args__){}
/** @return void */
function newt_grid_wrapped_window_at(resource $grid,string $title,int $left,int $top){}
/** @return void */
function newt_grid_wrapped_window(resource $grid,string $title){}
/** @return int */
function newt_init(){}
/** @return resource */
function newt_label(int $left,int $top,string $text){}
/** @return void */
function newt_label_set_text(resource $label,string $text){}
/** @return void */
function newt_listbox_append_entry(resource $listbox,string $text,mixed $data){}
/** @return void */
function newt_listbox_clear_selection(resource $listbox){}
/** @return void */
function newt_listbox_clear(resource $listobx){}
/** @return void */
function newt_listbox_delete_entry(resource $listbox,mixed $key){}
/** @return string */
function newt_listbox_get_current(resource $listbox){}
/** @return array */
function newt_listbox_get_selection(resource $listbox){}
/** @return void */
function newt_listbox_insert_entry(resource $listbox,string $text,mixed $data,mixed $key){}
/** @return int */
function newt_listbox_item_count(resource $listbox){}
/** @return resource */
function newt_listbox(int $left,int $top,int $height,int $flags){}
/** @return void */
function newt_listbox_select_item(resource $listbox,mixed $key,int $sense){}
/** @return void */
function newt_listbox_set_current_by_key(resource $listbox,mixed $key){}
/** @return void */
function newt_listbox_set_current(resource $listbox,int $num){}
/** @return void */
function newt_listbox_set_data(resource $listbox,int $num,mixed $data){}
/** @return void */
function newt_listbox_set_entry(resource $listbox,int $num,string $text){}
/** @return void */
function newt_listbox_set_width(resource $listbox,int $width){}
/** @return mixed */
function newt_listitem_get_data(resource $item){}
/** @return resource */
function newt_listitem(int $left,int $top,string $text,bool $is_default,resouce $prev_item,mixed $data,int $flags){}
/** @return void */
function newt_listitem_set(resource $item,string $text){}
/** @return int */
function newt_open_window(int $left,int $top,int $width,int $height,string $title){}
/** @return void */
...
/** @return resource */
function newt_radiobutton(int $left,int $top,string $text,bool $is_default,resource $prev_button){}
/** @return resource */
function newt_radio_get_current(resource $set_member){}
/** @return void */
function newt_redraw_help_line(){}
/** @return string */
function newt_reflow_text(string $text,int $width,int $flex_down,int $flex_up,int &$actual_width,int &$actual_height){}
/** @return void */
function newt_refresh(){}
/** @return void */
function newt_resize_screen(bool $redraw){}
/** @return void */
function newt_resume(){}
/** @return resource */
function newt_run_form(resource $form){}
/** @return resource */
function newt_scale(int $left,int $top,int $width,int $full_value){}
/** @return void */
function newt_scale_set(resource $scale,int $amount){}
/** @return void */
function newt_scrollbar_set(resource $scrollbar,int $where,int $total){}
/** @return void */
function newt_set_help_callback(mixed $function){}
/** @return void */
function newt_set_suspend_callback(callable $function,mixed $data){}
/** @return void */
function newt_suspend(){}
/** @return int */
function newt_textbox_get_num_lines(resource $textbox){}
/** @return resource */
function newt_textbox_reflowed(int $left,int $top,char $text,int $width,int $flex_down,int $flex_up,int $flags){}
/** @return resource */
function newt_textbox(int $left,int $top,int $width,int $height,int $flags){}
/** @return void */
function newt_textbox_set_height(resource $textbox,int $height){}
/** @return void */
function newt_textbox_set_text(resource $textbox,string $text){}
/** @return resource */
function newt_vertical_scrollbar(int $left,int $top,int $height,int $normal_colorset,int $thumb_colorset){}
/** @return void */
function newt_wait_for_key(){}
/** @return int */
function newt_win_choice(string $title,string $button1_text,string $button2_text,string $format,mixed $args,mixed $__args__){}
/** @return int */
function newt_win_entries(string $title,string $text,int $suggested_width,int $flex_down,int $flex_up,int $data_width,array &$items,string $button1,string $__args__){}
/** @return int */
function newt_win_menu(string $title,string $text,int $suggestedWidth,int $flexDown,int $flexUp,int $maxListHeight,array $items,int &$listItem,string $button1,string $__args__){}
/** @return void */
function newt_win_message(string $title,string $button_text,string $format,mixed $args,mixed $__args__){}
/** @return void */
function newt_win_messagev(string $title,string $button_text,string $format,array $args){}
/** @return int */
function newt_win_ternary(string $title,string $button1_text,string $button2_text,string $button3_text,string $format,mixed $args,mixed $__args__){}
/** @return mixed */
function next(array &$array){}
/** @return string */
function ngettext(string $msgid1,string $msgid2,int $n){}
/** @return string */
function nl2br(string $string,bool $is_xhtml){}
/** @return string */
...
/** @return string */
function nthmac(string $clent,string $data){}
/** @return string */
function nthmac(string $clent,string $data){}
/** @return string */
function number_format(float $number,int $decimals){}
/** @return 字符串 */
function oauth_get_sbs(字符串 $http_method,字符串 $uri,数组 $request_parameters){}
/** @return 字符串 */
function oauth_urlencode(字符串 $uri){}
/** @return void */
function ob_clean(){}
/** @return string */
...
/** @return bool */
function ob_start(callback $output_callback,int $chunk_size,bool $erase){}
/** @return string */
function ob_tidyhandler(string $input,int $mode){}
/** @return bool */
function oci_bind_array_by_name(resource $statement,string $name,array &$var_array,int $max_table_length,int $max_item_length,int $type){}
/** @return bool */
function oci_bind_by_name(resource $stmt,string $ph_name,mixed &$variable,int $maxlength,int $type){}
/** @return bool */
...
/** @return resource */
function oci_connect(string $username,string $password,string $db,string $charset,int $session_mode){}
/** @return bool */
function oci_define_by_name(resource $statement,string $column_name,mixed &$variable,int $type){}
/** @return array */
function oci_error(resource $source){}
/** @return bool */
function oci_execute(resource $stmt,int $mode){}
/** @return int */
function oci_fetch_all(resource $statement,array &$output,int $skip,int $maxrows,int $flags){}
/** @return array */
...
/** @return bool */
function oci_field_is_null(resource $statement,mixed $field){}
/** @return string */
function oci_field_name(resource $statement,int $field){}
/** @return int */
function oci_field_precision(resource $statement,int $field){}
/** @return int */
function oci_field_scale(resource $statement,int $field){}
/** @return int */
function oci_field_size(resource $stmt,mixed $field){}
/** @return mixed */
function oci_field_type(resource $stmt,int $field){}
/** @return int */
function oci_field_type_raw(resource $statement,int $field){}
/** @return bool */
function oci_free_descriptor(resource $descriptor){}
/** @return bool */
function oci_free_statement(resource $statement){}
/** @return resource */
function oci_get_implicit_resultset(resource $statement){}
/** @return void */
function oci_internal_debug(int $onoff){}
/** @return bool */
function oci_lob_copy(OCI_Lob $lob_to,OCI_Lob $lob_from,int $length){}
/** @return bool */
function oci_lob_is_equal(OCI_Lob $lob1,OCI_Lob $lob2){}
/** @return OCI_Collection */
function oci_new_collection(resource $connection,string $tdo,string $schema){}
/** @return resource */
function oci_new_connect(string $username,string $password,string $db,string $charset,int $session_mode){}
/** @return resource */
function oci_new_cursor(resource $connection){}
/** @return OCI_Lob */
function oci_new_descriptor(resource $connection,int $type){}
/** @return int */
function oci_num_fields(resource $statement){}
/** @return int */
function oci_num_rows(resource $stmt){}
/** @return resource */
function oci_parse(resource $connection,string $query){}
/** @return bool */
function oci_password_change(resource $connection,string $username,string $old_password,string $new_password){}
/** @return resource */
function oci_pconnect(string $username,string $password,string $db,string $charset,int $session_mode){}
/** @return mixed */
function oci_result(resource $statement,mixed $field){}
/** @return bool */
...
/** @return array */
function odbc_data_source(resource $connection_id,int $fetch_type){}
/** @return string */
function odbc_errormsg(resource $connection_id){}
/** @return string */
function odbc_error(resource $connection_id){}
/** @return resource */
function odbc_exec(resource $connection_id,string $query_string,int $flags){}
/** @return bool */
...
/** @return resource */
function odbc_procedurecolumns(resource $connection_id){}
/** @return resource */
function odbc_procedures(resource $connection_id){}
/** @return int */
...
/** @return array */
function opcache_get_status(boolean $get_scripts){}
/** @return boolean */
function opcache_invalidate(string $script,boolean $force){}
/** @return boolean */
function opcache_reset(){}
/** @return resource */
function openal_buffer_create(){}
/** @return bool */
function openal_buffer_data(resource $buffer,int $format,string $data,int $freq){}
/** @return bool */
...
/** @return bool */
function openal_source_set(resource $source,int $property,mixed $setting){}
/** @return bool */
function openal_source_stop(resource $source){}
/** @return resource */
function openal_stream(resource $source,int $format,int $rate){}
/** @return resource */
function opendir(string $path,resource $context){}
/** @return bool */
...
/** @return resource */
function openssl_csr_get_public_key(mixed $csr,bool $use_shortnames){}
/** @return array */
function openssl_csr_get_subject(mixed $csr,bool $use_shortnames){}
/** @return mixed */
function openssl_csr_new(array $dn,resource &$privkey,array $configargs,array $extraattribs){}
/** @return resource */
function openssl_csr_sign(mixed $csr,mixed $cacert,mixed $priv_key,int $days,array $configargs,int $serial){}
/** @return string */
function openssl_decrypt(string $data,string $method,string $password,int $options,string $iv){}
/** @return string */
function openssl_dh_compute_key(string $pub_key,resource $dh_key){}
/** @return string */
function openssl_digest(string $data,string $method,bool $raw_output){}
/** @return string */
function openssl_encrypt(string $data,string $method,string $password,int $options,string $iv){}
/** @return string */
...
/** @return array */
function openssl_get_cipher_methods(bool $aliases){}
/** @return array */
function openssl_get_md_methods(bool $aliases){}
/** @return bool */
function openssl_open(string $sealed_data,string &$open_data,string $env_key,mixed $priv_key_id,string $method){}
/** @return string */
function openssl_pbkdf2(string $password,string $salt,int $key_length,int $iterations,string $digest_algorithm){}
/** @return bool */
function openssl_pkcs12_export(mixed $x509,string &$out,mixed $priv_key,string $pass,array $args){}
/** @return bool */
function openssl_pkcs12_export_to_file(mixed $x509,string $filename,mixed $priv_key,string $pass,array $args){}
/** @return bool */
...
/** @return bool */
function openssl_pkcs7_encrypt(string $infile,string $outfile,mixed $recipcerts,array $headers,int $flags,int $cipherid){}
/** @return bool */
...
/** @return mixed */
function openssl_pkcs7_verify(string $filename,int $flags,string $outfilename,array $cainfo,string $extracerts,string $content){}
/** @return bool */
...
/** @return bool */
function openssl_public_decrypt(string $data,string &$decrypted,mixed $key,int $padding){}
/** @return bool */
function openssl_public_encrypt(string $data,string &$crypted,mixed $key,int $padding){}
/** @return string */
function openssl_random_pseudo_bytes(int $length,bool &$crypto_strong){}
/** @return int */
function openssl_seal(string $data,string &$sealed_data,array &$env_keys,array $pub_key_ids,string $method){}
/** @return bool */
function openssl_sign(string $data,string &$signature,mixed $priv_key_id,mixed $signature_alg){}
/** @return string */
function openssl_spki_export_challenge(string &$spkac){}
/** @return string */
function openssl_spki_export(string &$spkac){}
/** @return string */
function openssl_spki_new(resource &$privkey,string &$challenge,int $algorithm){}
/** @return string */
function openssl_spki_verify(string &$spkac){}
/** @return int */
function openssl_verify(string $data,string $signature,mixed $pub_key_id,mixed $signature_alg){}
/** @return bool */
...
/** @return bool */
function openssl_x509_fingerprint(mixed $x509,string $hash_algorithm,bool $raw_output){}
/** @return void */
...
/** @return bool */
function override_function(string $function_name,string $function_args,string $function_code){}
/** @return string */
function pack(string $format,mixed $args,mixed $__args__){}
/** @return array */
function parse_ini_file(string $filename,bool $process_sections,int $scanner_mode){}
/** @return array */
function parse_ini_string(string $ini,bool $process_sections,int $scanner_mode){}
/** @return array */
function parsekit_compile_file(string $filename,array &$errors,int $options){}
/** @return array */
function parsekit_compile_string(string $phpcode,array &$errors,int $options){}
/** @return array */
function parsekit_func_arginfo(mixed $function){}
/** @return void */
function parse_str(string $str,array &$arr){}
/** @return mixed */
function parse_url(string $url,int $component){}
/** @return void */
function passthru(string $command,int &$return_var){}
/** @return array */
function password_get_info(string $hash){}
/** @return string */
function password_hash(string $password,integer $algo,array $options){}
/** @return boolean */
function password_needs_rehash(string $hash,integer $algo,array $options){}
/** @return boolean */
function password_verify(string $password,string $hash){}
/** @return mixed */
function pathinfo(string $path,int $options){}
/** @return int */
...
/** @return int */
function pcntl_getpriority(int $pid,int $process_identifier){}
/** @return bool */
function pcntl_setpriority(int $priority,int $pid,int $process_identifier){}
/** @return bool */
function pcntl_signal(int $signo,callback $handler,bool $restart_syscalls){}
/** @return bool */
function pcntl_signal_dispatch(){}
/** @return bool */
function pcntl_sigprocmask(int $how,array $set,array &$oldset){}
/** @return int */
function pcntl_sigtimedwait(array $set,array &$siginfo,int $seconds,int $nanoseconds){}
/** @return int */
function pcntl_sigwaitinfo(array $set,array &$siginfo){}
/** @return string */
...
/** @return bool */
function PDF_activate_item(resource $pdfdoc,int $id){}
/** @return bool */
...
/** @return bool */
function PDF_add_nameddest(resource $pdfdoc,string $name,string $optlist){}
/** @return bool */
...
/** @return int */
function PDF_add_table_cell(resource $pdfdoc,int $table,int $column,int $row,string $text,string $optlist){}
/** @return int */
function PDF_add_textflow(resource $pdfdoc,int $textflow,string $text,string $optlist){}
/** @return bool */
...
/** @return bool */
function PDF_arc(resource $p,float $x,float $y,float $r,float $alpha,float $beta){}
/** @return bool */
function PDF_arcn(resource $p,float $x,float $y,float $r,float $alpha,float $beta){}
/** @return bool */
...
/** @return int */
function PDF_begin_document(resource $pdfdoc,string $filename,string $optlist){}
/** @return bool */
function PDF_begin_font(resource $pdfdoc,string $filename,float $a,float $b,float $c,float $d,float $e,float $f,string $optlist){}
/** @return bool */
function PDF_begin_glyph(resource $pdfdoc,string $glyphname,float $wx,float $llx,float $lly,float $urx,float $ury){}
/** @return int */
function PDF_begin_item(resource $pdfdoc,string $tag,string $optlist){}
/** @return bool */
function PDF_begin_layer(resource $pdfdoc,int $layer){}
/** @return bool */
function PDF_begin_page(resource $pdfdoc,float $width,float $height){}
/** @return bool */
function PDF_begin_page_ext(resource $pdfdoc,float $width,float $height,string $optlist){}
/** @return int */
function PDF_begin_pattern(resource $pdfdoc,float $width,float $height,float $xstep,float $ystep,int $painttype){}
/** @return int */
function PDF_begin_template_ext(resource $pdfdoc,float $width,float $height,string $optlist){}
/** @return int */
function PDF_begin_template(resource $pdfdoc,float $width,float $height){}
/** @return bool */
function PDF_circle(resource $pdfdoc,float $x,float $y,float $r){}
/** @return bool */
function PDF_clip(resource $p){}
/** @return bool */
function PDF_close(resource $p){}
/** @return bool */
function PDF_close_image(resource $p,int $image){}
/** @return bool */
function PDF_closepath(resource $p){}
/** @return bool */
function PDF_closepath_fill_stroke(resource $p){}
/** @return bool */
function PDF_closepath_stroke(resource $p){}
/** @return bool */
function PDF_close_pdi(resource $p,int $doc){}
/** @return bool */
function PDF_close_pdi_page(resource $p,int $page){}
/** @return bool */
function PDF_concat(resource $p,float $a,float $b,float $c,float $d,float $e,float $f){}
/** @return bool */
function PDF_continue_text(resource $p,string $text){}
/** @return int */
function PDF_create_3dview(resource $pdfdoc,string $username,string $optlist){}
/** @return int */
function PDF_create_action(resource $pdfdoc,string $type,string $optlist){}
/** @return bool */
function PDF_create_annotation(resource $pdfdoc,float $llx,float $lly,float $urx,float $ury,string $type,string $optlist){}
/** @return int */
function PDF_create_bookmark(resource $pdfdoc,string $text,string $optlist){}
/** @return bool */
function PDF_create_field(resource $pdfdoc,float $llx,float $lly,float $urx,float $ury,string $name,string $type,string $optlist){}
/** @return bool */
function PDF_create_fieldgroup(resource $pdfdoc,string $name,string $optlist){}
/** @return int */
function PDF_create_gstate(resource $pdfdoc,string $optlist){}
/** @return bool */
function PDF_create_pvf(resource $pdfdoc,string $filename,string $data,string $optlist){}
/** @return int */
function PDF_create_textflow(resource $pdfdoc,string $text,string $optlist){}
/** @return bool */
function PDF_curveto(resource $p,float $x1,float $y1,float $x2,float $y2,float $x3,float $y3){}
/** @return int */
function PDF_define_layer(resource $pdfdoc,string $name,string $optlist){}
/** @return bool */
function PDF_delete(resource $pdfdoc){}
/** @return int */
function PDF_delete_pvf(resource $pdfdoc,string $filename){}
/** @return bool */
function PDF_delete_table(resource $pdfdoc,int $table,string $optlist){}
/** @return bool */
function PDF_delete_textflow(resource $pdfdoc,int $textflow){}
/** @return bool */
function PDF_encoding_set_char(resource $pdfdoc,string $encoding,int $slot,string $glyphname,int $uv){}
/** @return bool */
function PDF_end_document(resource $pdfdoc,string $optlist){}
/** @return bool */
function PDF_end_font(resource $pdfdoc){}
/** @return bool */
function PDF_end_glyph(resource $pdfdoc){}
/** @return bool */
function PDF_end_item(resource $pdfdoc,int $id){}
/** @return bool */
function PDF_end_layer(resource $pdfdoc){}
/** @return bool */
function PDF_end_page(resource $p){}
/** @return bool */
function PDF_end_page_ext(resource $pdfdoc,string $optlist){}
/** @return bool */
function PDF_endpath(resource $p){}
/** @return bool */
function PDF_end_pattern(resource $p){}
/** @return bool */
function PDF_end_template(resource $p){}
/** @return bool */
function PDF_fill(resource $p){}
/** @return int */
function PDF_fill_imageblock(resource $pdfdoc,int $page,string $blockname,int $image,string $optlist){}
/** @return int */
function PDF_fill_pdfblock(resource $pdfdoc,int $page,string $blockname,int $contents,string $optlist){}
/** @return bool */
function PDF_fill_stroke(resource $p){}
/** @return int */
function PDF_fill_textblock(resource $pdfdoc,int $page,string $blockname,string $text,string $optlist){}
/** @return int */
function PDF_findfont(resource $p,string $fontname,string $encoding,int $embed){}
/** @return bool */
function PDF_fit_image(resource $pdfdoc,int $image,float $x,float $y,string $optlist){}
/** @return bool */
function PDF_fit_pdi_page(resource $pdfdoc,int $page,float $x,float $y,string $optlist){}
/** @return string */
function PDF_fit_table(resource $pdfdoc,int $table,float $llx,float $lly,float $urx,float $ury,string $optlist){}
/** @return string */
function PDF_fit_textflow(resource $pdfdoc,int $textflow,float $llx,float $lly,float $urx,float $ury,string $optlist){}
/** @return bool */
function PDF_fit_textline(resource $pdfdoc,string $text,float $x,float $y,string $optlist){}
/** @return string */
function PDF_get_apiname(resource $pdfdoc){}
/** @return string */
function PDF_get_buffer(resource $p){}
/** @return string */
function PDF_get_errmsg(resource $pdfdoc){}
/** @return int */
function PDF_get_errnum(resource $pdfdoc){}
/** @return int */
function PDF_get_majorversion(){}
/** @return int */
function PDF_get_minorversion(){}
/** @return string */
function PDF_get_parameter(resource $p,string $key,float $modifier){}
/** @return string */
function PDF_get_pdi_parameter(resource $p,string $key,int $doc,int $page,int $reserved){}
/** @return float */
function PDF_get_pdi_value(resource $p,string $key,int $doc,int $page,int $reserved){}
/** @return float */
function PDF_get_value(resource $p,string $key,float $modifier){}
/** @return float */
function PDF_info_font(resource $pdfdoc,int $font,string $keyword,string $optlist){}
/** @return float */
function PDF_info_matchbox(resource $pdfdoc,string $boxname,int $num,string $keyword){}
/** @return float */
function PDF_info_table(resource $pdfdoc,int $table,string $keyword){}
/** @return float */
function PDF_info_textflow(resource $pdfdoc,int $textflow,string $keyword){}
/** @return float */
function PDF_info_textline(resource $pdfdoc,string $text,string $keyword,string $optlist){}
/** @return bool */
function PDF_initgraphics(resource $p){}
/** @return bool */
function PDF_lineto(resource $p,float $x,float $y){}
/** @return int */
function PDF_load_3ddata(resource $pdfdoc,string $filename,string $optlist){}
/** @return int */
function PDF_load_font(resource $pdfdoc,string $fontname,string $encoding,string $optlist){}
/** @return int */
function PDF_load_iccprofile(resource $pdfdoc,string $profilename,string $optlist){}
/** @return int */
function PDF_load_image(resource $pdfdoc,string $imagetype,string $filename,string $optlist){}
/** @return int */
function PDF_makespotcolor(resource $p,string $spotname){}
/** @return bool */
function PDF_moveto(resource $p,float $x,float $y){}
/** @return resource */
function PDF_new(){}
/** @return int */
function PDF_open_ccitt(resource $pdfdoc,string $filename,int $width,int $height,int $BitReverse,int $k,int $Blackls1){}
/** @return bool */
function PDF_open_file(resource $p,string $filename){}
/** @return int */
function PDF_open_image_file(resource $p,string $imagetype,string $filename,string $stringparam,int $intparam){}
/** @return int */
function PDF_open_image(resource $p,string $imagetype,string $source,string $data,int $length,int $width,int $height,int $components,int $bpc,string $params){}
/** @return int */
function PDF_open_memory_image(resource $p,resource $image){}
/** @return int */
function PDF_open_pdi_document(resource $p,string $filename,string $optlist){}
/** @return int */
function PDF_open_pdi(resource $pdfdoc,string $filename,string $optlist,int $len){}
/** @return int */
function PDF_open_pdi_page(resource $p,int $doc,int $pagenumber,string $optlist){}
/** @return float */
function PDF_pcos_get_number(resource $p,int $doc,string $path){}
/** @return string */
function PDF_pcos_get_stream(resource $p,int $doc,string $optlist,string $path){}
/** @return string */
function PDF_pcos_get_string(resource $p,int $doc,string $path){}
/** @return bool */
function PDF_place_image(resource $pdfdoc,int $image,float $x,float $y,float $scale){}
/** @return bool */
function PDF_place_pdi_page(resource $pdfdoc,int $page,float $x,float $y,float $sx,float $sy){}
/** @return int */
function PDF_process_pdi(resource $pdfdoc,int $doc,int $page,string $optlist){}
/** @return bool */
function PDF_rect(resource $p,float $x,float $y,float $width,float $height){}
/** @return bool */
function PDF_restore(resource $p){}
/** @return bool */
function PDF_resume_page(resource $pdfdoc,string $optlist){}
/** @return bool */
function PDF_rotate(resource $p,float $phi){}
/** @return bool */
function PDF_save(resource $p){}
/** @return bool */
function PDF_scale(resource $p,float $sx,float $sy){}
/** @return bool */
function PDF_set_border_color(resource $p,float $red,float $green,float $blue){}
/** @return bool */
function PDF_set_border_dash(resource $pdfdoc,float $black,float $white){}
/** @return bool */
function PDF_set_border_style(resource $pdfdoc,string $style,float $width){}
/** @return bool */
function PDF_setcolor(resource $p,string $fstype,string $colorspace,float $c1,float $c2,float $c3,float $c4){}
/** @return bool */
function PDF_setdash(resource $pdfdoc,float $b,float $w){}
/** @return bool */
function PDF_setdashpattern(resource $pdfdoc,string $optlist){}
/** @return bool */
function PDF_setflat(resource $pdfdoc,float $flatness){}
/** @return bool */
function PDF_setfont(resource $pdfdoc,int $font,float $fontsize){}
/** @return bool */
function PDF_setgray(resource $p,float $g){}
/** @return bool */
function PDF_setgray_fill(resource $p,float $g){}
/** @return bool */
function PDF_setgray_stroke(resource $p,float $g){}
/** @return bool */
function PDF_set_gstate(resource $pdfdoc,int $gstate){}
/** @return bool */
function PDF_set_info(resource $p,string $key,string $value){}
/** @return bool */
function PDF_set_layer_dependency(resource $pdfdoc,string $type,string $optlist){}
/** @return bool */
function PDF_setlinecap(resource $p,int $linecap){}
/** @return bool */
function PDF_setlinejoin(resource $p,int $value){}
/** @return bool */
function PDF_setlinewidth(resource $p,float $width){}
/** @return bool */
function PDF_setmatrix(resource $p,float $a,float $b,float $c,float $d,float $e,float $f){}
/** @return bool */
function PDF_setmiterlimit(resource $pdfdoc,float $miter){}
/** @return bool */
function PDF_set_parameter(resource $p,string $key,string $value){}
/** @return bool */
function PDF_setrgbcolor(resource $p,float $red,float $green,float $blue){}
/** @return bool */
function PDF_setrgbcolor_fill(resource $p,float $red,float $green,float $blue){}
/** @return bool */
function PDF_setrgbcolor_stroke(resource $p,float $red,float $green,float $blue){}
/** @return bool */
function PDF_set_text_pos(resource $p,float $x,float $y){}
/** @return bool */
function PDF_set_value(resource $p,string $key,float $value){}
/** @return int */
function PDF_shading(resource $pdfdoc,string $shtype,float $x0,float $y0,float $x1,float $y1,float $c1,float $c2,float $c3,float $c4,string $optlist){}
/** @return int */
function PDF_shading_pattern(resource $pdfdoc,int $shading,string $optlist){}
/** @return bool */
function PDF_shfill(resource $pdfdoc,int $shading){}
/** @return bool */
function PDF_show(resource $pdfdoc,string $text){}
/** @return int */
function PDF_show_boxed(resource $p,string $text,float $left,float $top,float $width,float $height,string $mode,string $feature){}
/** @return bool */
function PDF_show_xy(resource $p,string $text,float $x,float $y){}
/** @return bool */
function PDF_skew(resource $p,float $alpha,float $beta){}
/** @return float */
function PDF_stringwidth(resource $p,string $text,int $font,float $fontsize){}
/** @return bool */
function PDF_stroke(resource $p){}
/** @return bool */
function PDF_suspend_page(resource $pdfdoc,string $optlist){}
/** @return bool */
function PDF_translate(resource $p,float $tx,float $ty){}
/** @return string */
function PDF_utf16_to_utf8(resource $pdfdoc,string $utf16string){}
/** @return string */
function PDF_utf32_to_utf16(resource $pdfdoc,string $utf32string,string $ordering){}
/** @return string */
function PDF_utf8_to_utf16(resource $pdfdoc,string $utf8string,string $ordering){}
/** @return resource */
function pfsockopen(string $hostname,int $port,int &$errno,string &$errstr,float $timeout){}
/** @return int */
...
/** @return int */
function pg_connect_poll(resource $connection){}
/** @return resource */
function pg_connect(string $connection_string){}
/** @return bool */
function pg_consume_input(resource $connection){}
/** @return array */
...
/** @return string */
function pg_escape_identifier(resource $connection,string $data){}
/** @return string */
function pg_escape_literal(resource $connection,string $data){}
/** @return string */
function pg_escape_string(string $data){}
/** @return resource */
function pg_execute(resource $connection,string $stmtname,array $params){}
/** @return array */
function pg_fetch_all(resource $result){}
/** @return array */
function pg_fetch_all_columns(resource $result,int $column){}
/** @return array */
...
/** @return bool */
function pg_lo_export(resource $connection,int $oid,string $pathname){}
/** @return int */
function pg_lo_import(resource $connection,string $pathname,mixed $object_id){}
/** @return resource */
...
/** @return bool */
function pg_lo_truncate(resource $large_object,int $size){}
/** @return bool */
...
/** @return resource */
function pg_pconnect(string $connection_string,int $connect_type){}
/** @return bool */
...
/** @return resource */
function pg_query_params(resource $connection,string $query,array $params){}
/** @return resource */
...
/** @return bool */
function pg_send_execute(resource $connection,string $stmtname,array $params){}
/** @return bool */
function pg_send_prepare(resource $connection,string $stmtname,string $query){}
/** @return bool */
function pg_send_query(resource $connection,string $query){}
/** @return bool */
function pg_send_query_params(resource $connection,string $query,array $params){}
/** @return int */
...
/** @return resource */
function pg_socket(resource $connection){}
/** @return bool */
function pg_trace(string $pathname,string $mode,resource $connection){}
/** @return int */
function pg_transaction_status(resource $connection){}
/** @return string */
...
/** @return bool */
function php_check_syntax(string $filename,string &$error_message){}
/** @return bool */
...
/** @return bool */
function posix_access(string $file,int $mode){}
/** @return string */
...
/** @return bool */
function posix_isatty(mixed $fd){}
/** @return bool */
function posix_kill(int $pid,int $sig){}
/** @return bool */
function posix_mkfifo(string $pathname,int $mode){}
/** @return bool */
function posix_mknod(string $pathname,int $mode,int $major,int $minor){}
/** @return bool */
...
/** @return string */
function posix_ttyname(mixed $fd){}
/** @return array */
function posix_uname(){}
/** @return number */
function pow(number $base,number $exp){}
/** @return mixed */
function preg_filter(mixed $pattern,mixed $replacement,mixed $subject,int $limit,int &$count){}
/** @return array */
function preg_grep(string $pattern,array $input,int $flags){}
/** @return int */
function preg_last_error(){}
/** @return int */
function preg_match_all(string $pattern,string $subject,array &$matches,int $flags,int $offset){}
/** @return int */
function preg_match(string $pattern,string $subject,array &$matches,int $flags,int $offset){}
/** @return string */
function preg_quote(string $str,string $delimiter){}
/** @return mixed */
function preg_replace_callback(mixed $pattern,callable $callback,mixed $subject,int $limit,int &$count){}
/** @return mixed */
function preg_replace(mixed $pattern,mixed $replacement,mixed $subject,int $limit,int &$count){}
/** @return array */
function preg_split(string $pattern,string $subject,int $limit,int $flags){}
/** @return mixed */
function prev(array &$array){}
/** @return int */
function printf(string $format,mixed $args,mixed $__args__){}
/** @return int */
...
/** @return bool */
function property_exists(mixed $class,string $property){}
/** @return int */
function ps_add_bookmark(resource $psdoc,string $text,int $parent,int $open){}
/** @return bool */
function ps_add_launchlink(resource $psdoc,float $llx,float $lly,float $urx,float $ury,string $filename){}
/** @return bool */
function ps_add_locallink(resource $psdoc,float $llx,float $lly,float $urx,float $ury,int $page,string $dest){}
/** @return bool */
function ps_add_note(resource $psdoc,float $llx,float $lly,float $urx,float $ury,string $contents,string $title,string $icon,int $open){}
/** @return bool */
function ps_add_pdflink(resource $psdoc,float $llx,float $lly,float $urx,float $ury,string $filename,int $page,string $dest){}
/** @return bool */
function ps_add_weblink(resource $psdoc,float $llx,float $lly,float $urx,float $ury,string $url){}
/** @return bool */
function ps_arc(resource $psdoc,float $x,float $y,float $radius,float $alpha,float $beta){}
/** @return bool */
function ps_arcn(resource $psdoc,float $x,float $y,float $radius,float $alpha,float $beta){}
/** @return bool */
function ps_begin_page(resource $psdoc,float $width,float $height){}
/** @return int */
function ps_begin_pattern(resource $psdoc,float $width,float $height,float $xstep,float $ystep,int $painttype){}
/** @return int */
function ps_begin_template(resource $psdoc,float $width,float $height){}
/** @return bool */
function ps_circle(resource $psdoc,float $x,float $y,float $radius){}
/** @return bool */
...
/** @return bool */
function ps_curveto(resource $psdoc,float $x1,float $y1,float $x2,float $y2,float $x3,float $y3){}
/** @return bool */
...
/** @return int */
function ps_findfont(resource $psdoc,string $fontname,string $encoding,bool $embed){}
/** @return string */
function ps_get_buffer(resource $psdoc){}
/** @return string */
function ps_get_parameter(resource $psdoc,string $name,float $modifier){}
/** @return float */
function ps_get_value(resource $psdoc,string $name,float $modifier){}
/** @return array */
...
/** @return int */
function ps_makespotcolor(resource $psdoc,string $name,int $reserved){}
/** @return bool */
...
/** @return int */
function ps_open_image_file(resource $psdoc,string $type,string $filename,string $stringparam,int $intparam){}
/** @return int */
function ps_open_image(resource $psdoc,string $type,string $source,string $data,int $lenght,int $width,int $height,int $components,int $bpc,string $params){}
/** @return int */
...
/** @return bool */
function ps_place_image(resource $psdoc,int $imageid,float $x,float $y,float $scale){}
/** @return bool */
function ps_rect(resource $psdoc,float $x,float $y,float $width,float $height){}
/** @return bool */
...
/** @return bool */
function ps_set_border_color(resource $psdoc,float $red,float $green,float $blue){}
/** @return bool */
function ps_set_border_dash(resource $psdoc,float $black,float $white){}
/** @return bool */
function ps_set_border_style(resource $psdoc,string $style,float $width){}
/** @return bool */
function ps_setcolor(resource $psdoc,string $type,string $colorspace,float $c1,float $c2,float $c3,float $c4){}
/** @return bool */
...
/** @return bool */
function ps_set_parameter(resource $psdoc,string $name,string $value){}
/** @return bool */
...
/** @return int */
function ps_shading(resource $psdoc,string $type,float $x0,float $y0,float $x1,float $y1,float $c1,float $c2,float $c3,float $c4,string $optlist){}
/** @return int */
function ps_shading_pattern(resource $psdoc,int $shadingid,string $optlist){}
/** @return bool */
...
/** @return int */
function ps_show_boxed(resource $psdoc,string $text,float $left,float $bottom,float $width,float $height,string $hmode,string $feature){}
/** @return bool */
function ps_show_xy2(resource $psdoc,string $text,int $len,float $xcoor,float $ycoor){}
/** @return bool */
function ps_show_xy(resource $psdoc,string $text,float $x,float $y){}
/** @return array */
function ps_string_geometry(resource $psdoc,string $text,int $fontid,float $size){}
/** @return float */
function ps_stringwidth(resource $psdoc,string $text,int $fontid,float $size){}
/** @return bool */
function ps_stroke(resource $psdoc){}
/** @return bool */
function ps_symbol(resource $psdoc,int $ord){}
/** @return string */
function ps_symbol_name(resource $psdoc,int $ord,int $fontid){}
/** @return float */
function ps_symbol_width(resource $psdoc,int $ord,int $fontid,float $size){}
/** @return bool */
function ps_translate(resource $psdoc,float $x,float $y){}
/** @return bool */
function putenv(string $setting){}
/** @return bool */
function px_close(resource $pxdoc){}
/** @return bool */
function px_create_fp(resource $pxdoc,resource $file,array $fielddesc){}
/** @return string */
function px_date2string(resource $pxdoc,int $value,string $format){}
/** @return bool */
function px_delete(resource $pxdoc){}
/** @return bool */
function px_delete_record(resource $pxdoc,int $num){}
/** @return array */
function px_get_field(resource $pxdoc,int $fieldno){}
/** @return array */
function px_get_info(resource $pxdoc){}
/** @return string */
function px_get_parameter(resource $pxdoc,string $name){}
/** @return array */
function px_get_record(resource $pxdoc,int $num,int $mode){}
/** @return array */
function px_get_schema(resource $pxdoc,int $mode){}
/** @return float */
function px_get_value(resource $pxdoc,string $name){}
/** @return int */
function px_insert_record(resource $pxdoc,array $data){}
/** @return resource */
function px_new(){}
/** @return int */
function px_numfields(resource $pxdoc){}
/** @return int */
function px_numrecords(resource $pxdoc){}
/** @return bool */
function px_open_fp(resource $pxdoc,resource $file){}
/** @return bool */
function px_put_record(resource $pxdoc,array $record,int $recpos){}
/** @return array */
function px_retrieve_record(resource $pxdoc,int $num,int $mode){}
/** @return bool */
function px_set_blob_file(resource $pxdoc,string $filename){}
/** @return bool */
function px_set_parameter(resource $pxdoc,string $name,string $value){}
/** @return void */
function px_set_tablename(resource $pxdoc,string $name){}
/** @return bool */
function px_set_targetencoding(resource $pxdoc,string $encoding){}
/** @return bool */
function px_set_value(resource $pxdoc,string $name,float $value){}
/** @return string */
function px_timestamp2string(resource $pxdoc,float $value,string $format){}
/** @return bool */
function px_update_record(resource $pxdoc,array $data,int $num){}
/** @return string */
...
/** @return bool */
function radius_put_addr(resource $radius_handle,int $type,string $addr,int $options,int $tag){}
/** @return bool */
function radius_put_attr(resource $radius_handle,int $type,string $value,int $options,int $tag){}
/** @return bool */
function radius_put_int(resource $radius_handle,int $type,int $value,int $options,int $tag){}
/** @return bool */
function radius_put_string(resource $radius_handle,int $type,string $value,int $options,int $tag){}
/** @return bool */
function radius_put_vendor_addr(resource $radius_handle,int $vendor,int $type,string $addr){}
/** @return bool */
function radius_put_vendor_attr(resource $radius_handle,int $vendor,int $type,string $value,int $options,int $tag){}
/** @return bool */
function radius_put_vendor_int(resource $radius_handle,int $vendor,int $type,int $value,int $options,int $tag){}
/** @return bool */
function radius_put_vendor_string(resource $radius_handle,int $vendor,int $type,string $value,int $options,int $tag){}
/** @return string */
function radius_request_authenticator(resource $radius_handle){}
/** @return string */
function radius_salt_encrypt_attr(resource $radius_handle,string $data){}
/** @return int */
...
function rand(){}
/** @return array */
function range(mixed $start,mixed $limit,number $step){}
/** @return string */
...
/** @return int */
function readfile(string $filename,bool $use_include_path,resource $context){}
/** @return int */
...
/** @return void */
function register_shutdown_function(callable $callback,mixed $parameter,mixed $__args__){}
/** @return bool */
function register_tick_function(callable $function,mixed $arg,mixed $__args__){}
/** @return bool */
function rename(string $oldname,string $newname,resource $context){}
/** @return bool */
function rename_function(string $original_name,string $new_name){}
/** @return mixed */
...
/** @return bool */
function rmdir(string $dirname,resource $context){}
/** @return float */
function round(float $val,int $precision,int $mode){}
/** @return bool */
function rpm_close(resource $rpmr){}
/** @return mixed */
function rpm_get_tag(resource $rpmr,int $tagnum){}
/** @return bool */
...
/** @return int */
function rrd_first(string $file,int $raaindex){}
/** @return array */
...
/** @return bool */
function rrd_restore(string $xml_file,string $rrd_file,array $options){}
/** @return bool */
...
/** @return bool */
function runkit_class_adopt(string $classname,string $parentname){}
/** @return bool */
function runkit_class_emancipate(string $classname){}
/** @return bool */
function runkit_constant_add(string $constname,mixed $value){}
/** @return bool */
function runkit_constant_redefine(string $constname,mixed $newvalue){}
/** @return bool */
function runkit_constant_remove(string $constname){}
/** @return bool */
function runkit_function_add(string $funcname,string $arglist,string $code){}
/** @return bool */
function runkit_function_copy(string $funcname,string $targetname){}
/** @return bool */
function runkit_function_redefine(string $funcname,string $arglist,string $code){}
/** @return bool */
function runkit_function_remove(string $funcname){}
/** @return bool */
function runkit_function_rename(string $funcname,string $newname){}
/** @return bool */
function runkit_import(string $filename,int $flags){}
/** @return bool */
function runkit_lint(string $code){}
/** @return bool */
function runkit_lint_file(string $filename){}
/** @return bool */
function runkit_method_add(string $classname,string $methodname,string $args,string $code,int $flags){}
/** @return bool */
function runkit_method_copy(string $dClass,string $dMethod,string $sClass,string $sMethod){}
/** @return bool */
function runkit_method_redefine(string $classname,string $methodname,string $args,string $code,int $flags){}
/** @return bool */
function runkit_method_remove(string $classname,string $methodname){}
/** @return bool */
function runkit_method_rename(string $classname,string $methodname,string $newname){}
/** @return bool */
function runkit_return_value_used(){}
/** @return mixed */
function runkit_sandbox_output_handler(object $sandbox,mixed $callback){}
/** @return array */
function runkit_superglobals(){}
/** @return array */
function scandir(string $directory,int $sorting_order,resource $context){}
/** @return bool */
function sem_acquire(resource $sem_identifier){}
/** @return resource */
function sem_get(int $key,int $max_acquire,int $perm,int $auto_release){}
/** @return bool */
...
/** @return int */
function session_cache_expire(string $new_cache_expire){}
/** @return string */
...
/** @return bool */
function session_pgsql_add_error(int $error_level,string $error_message){}
/** @return array */
function session_pgsql_get_error(bool $with_error_message){}
/** @return string */
function session_pgsql_get_field(){}
/** @return bool */
function session_pgsql_reset(){}
/** @return bool */
function session_pgsql_set_field(string $value){}
/** @return array */
function session_pgsql_status(){}
/** @return bool */
function session_regenerate_id(bool $delete_old_session){}
/** @return bool */
function session_register(mixed $name,mixed $__args__){}
/** @return void */
...
/** @return void */
function session_set_cookie_params(int $lifetime,string $path,string $domain,bool $secure,bool $httponly){}
/** @return bool */
function session_set_save_handler(callable $open,callable $close,callable $read,callable $write,callable $destroy,callable $gc,callable $create_sid){}
/** @return bool */
...
/** @return bool */
function setcookie(string $name,string $value,int $expire,string $path,string $domain,bool $secure,bool $httponly){}
/** @return mixed */
function set_error_handler(callable $error_handler,int $error_types){}
/** @return callable */
function set_exception_handler(callable $exception_handler){}
/** @return string */
function set_include_path(string $new_include_path){}
/** @return string */
function setlocale(int $category,string $locale,string $__args__){}
/** @return bool */
function set_magic_quotes_runtime(bool $new_setting){}
/** @return void */
function setproctitle(string $title){}
/** @return bool */
function setrawcookie(string $name,string $value,int $expire,string $path,string $domain,bool $secure,bool $httponly){}
/** @return bool */
function setthreadtitle(string $title){}
/** @return void */
...
/** @return bool */
function shm_detach(resource $shm_identifier){}
/** @return mixed */
function shm_get_var(resource $shm_identifier,int $variable_key){}
/** @return bool */
function shm_has_var(resource $shm_identifier,int $variable_key){}
/** @return void */
...
/** @return bool */
function shm_put_var(resource $shm_identifier,int $variable_key,mixed $variable){}
/** @return bool */
function shm_remove(resource $shm_identifier){}
/** @return bool */
function shm_remove_var(resource $shm_identifier,int $variable_key){}
/** @return bool */
function shuffle(array &$array){}
/** @return int */
function similar_text(string $first,string $second,float &$percent){}
/** @return SimpleXMLElement */
function simplexml_import_dom(DOMNode $node,string $class_name){}
/** @return SimpleXMLElement */
function simplexml_load_file(string $filename,string $class_name,int $options,string $ns,bool $is_prefix){}
/** @return SimpleXMLElement */
function simplexml_load_string(string $data,string $class_name,int $options,string $ns,bool $is_prefix){}
/** @return float */
...
/** @return string */
function snmp2_getnext(string $host,string $community,string $object_id,string $timeout,string $retries){}
/** @return string */
function snmp2_get(string $host,string $community,string $object_id,string $timeout,string $retries){}
/** @return array */
function snmp2_real_walk(string $host,string $community,string $object_id,string $timeout,string $retries){}
/** @return bool */
function snmp2_set(string $host,string $community,string $object_id,string $type,string $value,string $timeout,string $retries){}
/** @return array */
function snmp2_walk(string $host,string $community,string $object_id,string $timeout,string $retries){}
/** @return string */
function snmp3_getnext(string $host,string $sec_name,string $sec_level,string $auth_protocol,string $auth_passphrase,string $priv_protocol,string $priv_passphrase,string $object_id,string $timeout,string $retries){}
/** @return string */
function snmp3_get(string $host,string $sec_name,string $sec_level,string $auth_protocol,string $auth_passphrase,string $priv_protocol,string $priv_passphrase,string $object_id,string $timeout,string $retries){}
/** @return array */
function snmp3_real_walk(string $host,string $sec_name,string $sec_level,string $auth_protocol,string $auth_passphrase,string $priv_protocol,string $priv_passphrase,string $object_id,string $timeout,string $retries){}
/** @return bool */
function snmp3_set(string $host,string $sec_name,string $sec_level,string $auth_protocol,string $auth_passphrase,string $priv_protocol,string $priv_passphrase,string $object_id,string $type,string $value,int $timeout,int $retries){}
/** @return array */
function snmp3_walk(string $host,string $sec_name,string $sec_level,string $auth_protocol,string $auth_passphrase,string $priv_protocol,string $priv_passphrase,string $object_id,string $timeout,string $retries){}
/** @return string */
function snmpgetnext(string $host,string $community,string $object_id,int $timeout,int $retries){}
/** @return bool */
...
/** @return int */
function socket_cmsg_space(int $level,int $type){}
/** @return bool */
...
/** @return bool */
function socket_getpeername(resource $socket,string &$address,int &$port){}
/** @return bool */
...
/** @return int */
function socket_recvmsg(resource $socket,string $message,int $flags){}
/** @return int */
...
/** @return int */
function socket_sendmsg(resource $socket,array $message,int $flags){}
/** @return int */
...
/** @return bool */
function spl_autoload_register(callback $autoload_function){}
/** @return bool */
function spl_autoload_unregister(mixed $autoload_function){}
/** @return void */
...
/** @return string */
function sprintf(string $format,mixed $args,mixed $__args__){}
/** @return array */
...
/** @return void */
function sqlite_create_aggregate(resource $dbhandle,string $function_name,callable $step_func,callable $finalize_func,int $num_args){}
/** @return void */
function sqlite_create_function(resource $dbhandle,string $function_name,callable $callback,int $num_args){}
/** @return array */
...
/** @return bool */
function sqlite_exec(resource $dbhandle,string $query,string &$error_msg){}
/** @return SQLiteDatabase */
function sqlite_factory(string $filename,int $mode,string &$error_message){}
/** @return array */
function sqlite_fetch_all(resource $result,int $result_type,bool $decode_binary){}
/** @return array */
function sqlite_fetch_array(resource $result,int $result_type,bool $decode_binary){}
/** @return array */
function sqlite_fetch_column_types(string $table_name,resource $dbhandle,int $result_type){}
/** @return object */
function sqlite_fetch_object(resource $result,string $class_name,array $ctor_params,bool $decode_binary){}
/** @return string */
function sqlite_fetch_single(resource $result,bool $decode_binary){}
/** @return string */
function sqlite_field_name(resource $result,int $field_index){}
/** @return bool */
function sqlite_has_more(resource $result){}
/** @return bool */
function sqlite_has_prev(resource $result){}
/** @return int */
...
/** @return bool */
function sqlite_prev(resource $result){}
/** @return resource */
function sqlite_query(resource $dbhandle,string $query,int $result_type,string &$error_msg){}
/** @return bool */
function sqlite_rewind(resource $result){}
/** @return bool */
function sqlite_seek(resource $result,int $rownum){}
/** @return array */
function sqlite_single_query(resource $db,string $query,bool $first_row_only,bool $decode_binary){}
/** @return string */
function sqlite_udf_decode_binary(string $data){}
/** @return string */
function sqlite_udf_encode_binary(string $data){}
/** @return resource */
function sqlite_unbuffered_query(resource $dbhandle,string $query,int $result_type,string &$error_msg){}
/** @return bool */
function sqlite_valid(resource $result){}
/** @return string */
...
/** @return array */
function sqlsrv_fetch_array(resource $stmt,int $fetchType,int $row,int $offset){}
/** @return mixed */
function sqlsrv_fetch(resource $stmt,int $row,int $offset){}
/** @return mixed */
function sqlsrv_fetch_object(resource $stmt,string $className,array $ctorParams,int $row,int $offset){}
/** @return mixed */
...
/** @return mixed */
function sqlsrv_get_field(resource $stmt,int $fieldIndex,int $getAsType){}
/** @return bool */
...
/** @return mixed */
function sqlsrv_prepare(resource $conn,string $sql,array $params,array $options){}
/** @return mixed */
function sqlsrv_query(resource $conn,string $sql,array $params,array $options){}
/** @return bool */
...
/** @return mixed */
function sscanf(string $str,string $format,mixed &$__args__){}
/** @return int */
...
/** @return bool */
function ssh2_auth_hostbased_file(resource $session,string $username,string $hostname,string $pubkeyfile,string $privkeyfile,string $passphrase,string $local_username){}
/** @return mixed */
...
/** @return bool */
function ssh2_auth_pubkey_file(resource $session,string $username,string $pubkeyfile,string $privkeyfile,string $passphrase){}
/** @return resource */
function ssh2_connect(string $host,int $port,array $methods,array $callbacks){}
/** @return resource */
function ssh2_exec(resource $session,string $command,string $pty,array $env,int $width,int $height,int $width_height_type){}
/** @return resource */
function ssh2_fetch_stream(resource $channel,int $streamid){}
/** @return string */
function ssh2_fingerprint(resource $session,int $flags){}
/** @return array */
function ssh2_methods_negotiated(resource $session){}
/** @return bool */
function ssh2_publickey_add(resource $pkey,string $algoname,string $blob,bool $overwrite,array $attributes){}
/** @return resource */
function ssh2_publickey_init(resource $session){}
/** @return array */
function ssh2_publickey_list(resource $pkey){}
/** @return bool */
function ssh2_publickey_remove(resource $pkey,string $algoname,string $blob){}
/** @return bool */
function ssh2_scp_recv(resource $session,string $remote_file,string $local_file){}
/** @return bool */
function ssh2_scp_send(resource $session,string $local_file,string $remote_file,int $create_mode){}
/** @return bool */
function ssh2_sftp_chmod(resource $sftp,string $filename,int $mode){}
/** @return array */
function ssh2_sftp_lstat(resource $sftp,string $path){}
/** @return bool */
function ssh2_sftp_mkdir(resource $sftp,string $dirname,int $mode,bool $recursive){}
/** @return string */
...
/** @return bool */
function ssh2_sftp_symlink(resource $sftp,string $target,string $link){}
/** @return bool */
function ssh2_sftp_unlink(resource $sftp,string $filename){}
/** @return resource */
function ssh2_shell(resource $session,string $term_type,array $env,int $width,int $height,int $width_height_type){}
/** @return resource */
...
/** @return float */
function stats_cdf_beta(float $par1,float $par2,float $par3,int $which){}
/** @return float */
function stats_cdf_binomial(float $par1,float $par2,float $par3,int $which){}
/** @return float */
function stats_cdf_cauchy(float $par1,float $par2,float $par3,int $which){}
/** @return float */
function stats_cdf_chisquare(float $par1,float $par2,int $which){}
/** @return float */
function stats_cdf_exponential(float $par1,float $par2,int $which){}
/** @return float */
function stats_cdf_f(float $par1,float $par2,float $par3,int $which){}
/** @return float */
function stats_cdf_gamma(float $par1,float $par2,float $par3,int $which){}
/** @return float */
function stats_cdf_laplace(float $par1,float $par2,float $par3,int $which){}
/** @return float */
function stats_cdf_logistic(float $par1,float $par2,float $par3,int $which){}
/** @return float */
function stats_cdf_negative_binomial(float $par1,float $par2,float $par3,int $which){}
/** @return float */
function stats_cdf_noncentral_chisquare(float $par1,float $par2,float $par3,int $which){}
/** @return float */
function stats_cdf_noncentral_f(float $par1,float $par2,float $par3,float $par4,int $which){}
/** @return float */
function stats_cdf_poisson(float $par1,float $par2,int $which){}
/** @return float */
function stats_cdf_t(float $par1,float $par2,int $which){}
/** @return float */
function stats_cdf_uniform(float $par1,float $par2,float $par3,int $which){}
/** @return float */
function stats_cdf_weibull(float $par1,float $par2,float $par3,int $which){}
/** @return float */
...
/** @return float */
function stats_dens_negative_binomial(float $x,float $n,float $pi){}
/** @return float */
...
/** @return float */
function stats_den_uniform(float $x,float $a,float $b){}
/** @return number */
...
/** @return float */
function stats_rand_gen_noncenral_chisquare(float $df,float $xnonc){}
/** @return float */
function stats_rand_gen_noncentral_f(float $dfn,float $dfd,float $xnonc){}
/** @return float */
...
/** @return int */
function strcspn(string $str1,string $str2,int $start,int $length){}
/** @return void */
...
/** @return array */
function stream_context_get_params(resource $stream_or_context){}
/** @return resource */
function stream_context_set_default(array $options){}
/** @return bool */
function stream_context_set_option(resource $stream_or_context,string $wrapper,string $option,mixed $value){}
/** @return bool */
function stream_context_set_params(resource $stream_or_context,array $params){}
/** @return int */
function stream_copy_to_stream(resource $source,resource $dest,int $maxlength,int $offset){}
/** @return bool */
function stream_encoding(resource $stream,string $encoding){}
/** @return resource */
...
/** @return string */
function stream_get_contents(resource $handle,int $maxlength,int $offset){}
/** @return array */
function stream_get_filters(){}
/** @return string */
function stream_get_line(resource $handle,int $length,string $ending){}
/** @return array */
function stream_get_meta_data(int $fp){}
/** @return array */
function stream_get_transports(){}
/** @return array */
function stream_get_wrappers(){}
/** @return bool */
function stream_is_local(mixed $stream_or_url){}
/** @return void */
function stream_notification_callback(int $notification_code,int $severity,string $message,int $message_code,int $bytes_transferred,int $bytes_max){}
/** @return boolean */
...
/** @return int */
function stream_set_chunk_size(resource $fp,int $chunk_size){}
/** @return int */
function stream_set_read_buffer(resource $stream,int $buffer){}
/** @return bool */
...
/** @return resource */
function stream_socket_accept(resource $server_socket,float $timeout,string &$peername){}
/** @return resource */
function stream_socket_client(string $remote_socket,int &$errno,string &$errstr,float $timeout,int $flags,resource $context){}
/** @return mixed */
function stream_socket_enable_crypto(resource $stream,bool $enable,int $crypto_type,resource $session_stream){}
/** @return string */
...
/** @return string */
function stristr(string $haystack,mixed $needle,bool $before_needle){}
/** @return int */
...
/** @return mixed */
function strpos(string $haystack,mixed $needle,int $offset){}
/** @return array */
function strptime(string $date,string $format){}
/** @return string */
function strrchr(string $haystack,mixed $needle){}
/** @return string */
...
/** @return int */
function strrpos(string $haystack,string $needle,int $offset){}
/** @return string */
function str_shuffle(string $str){}
/** @return array */
function str_split(string $string,int $split_length){}
/** @return int */
function strspn(string $subject,string $mask,int $start,int $length){}
/** @return string */
function strstr(string $haystack,mixed $needle,bool $before_needle){}
/** @return string */
...
/** @return mixed */
function str_word_count(string $string,int $format,string $charlist){}
/** @return int */
function substr_compare(string $main_str,string $str,int $offset,int $length,bool $case_insensitivity){}
/** @return int */
function substr_count(string $haystack,string $needle,int $offset,int $length){}
/** @return mixed */
function substr_replace(mixed $string,mixed $replacement,mixed $start,mixed $length){}
/** @return string */
function substr(string $string,int $start,int $length){}
/** @return bool */
function svn_add(string $path,bool $recursive,bool $force){}
/** @return string */
function svn_auth_get_parameter(string $key){}
/** @return void */
function svn_auth_set_parameter(string $key,string $value){}
/** @return array */
function svn_blame(string $repository_url,int $revision_no){}
/** @return string */
function svn_cat(string $repos_url,int $revision_no){}
/** @return bool */
function svn_checkout(string $repos,string $targetpath,int $revision,int $flags){}
/** @return bool */
function svn_cleanup(string $workingdir){}
/** @return string */
function svn_client_version(){}
/** @return array */
function svn_commit(string $log,array $targets,bool $recursive){}
/** @return bool */
function svn_delete(string $path,bool $force){}
/** @return array */
function svn_diff(string $path1,int $rev1,string $path2,int $rev2){}
/** @return bool */
function svn_export(string $frompath,string $topath,bool $working_copy,int $revision_no){}
/** @return bool */
...
/** @return bool */
function svn_fs_change_node_prop(resource $root,string $path,string $name,string $value){}
/** @return int */
function svn_fs_check_path(resource $fsroot,string $path){}
/** @return bool */
function svn_fs_contents_changed(resource $root1,string $path1,resource $root2,string $path2){}
/** @return bool */
function svn_fs_copy(resource $from_root,string $from_path,resource $to_root,string $to_path){}
/** @return bool */
...
/** @return string */
function svn_fs_node_prop(resource $fsroot,string $path,string $propname){}
/** @return bool */
function svn_fs_props_changed(resource $root1,string $path1,resource $root2,string $path2){}
/** @return string */
function svn_fs_revision_prop(resource $fs,int $revnum,string $propname){}
/** @return resource */
...
/** @return array */
function svn_log(string $repos_url,int $start_revision,int $end_revision,int $limit,int $flags){}
/** @return array */
function svn_ls(string $repos_url,int $revision_no,bool $recurse,bool $peg){}
/** @return bool */
function svn_mkdir(string $path,string $log_message){}
/** @return resource */
function svn_repos_create(string $path,array $config,array $fsconfig){}
/** @return resource */
function svn_repos_fs_begin_txn_for_commit(resource $repos,int $rev,string $author,string $log_msg){}
/** @return int */
...
/** @return bool */
function svn_revert(string $path,bool $recursive){}
/** @return array */
function svn_status(string $path,int $flags){}
/** @return int */
function svn_update(string $path,int $revno,bool $recurse){}
/** @return int */
function sybase_affected_rows(resource $link_identifier){}
/** @return bool */
function sybase_close(resource $link_identifier){}
/** @return resource */
function sybase_connect(string $servername,string $username,string $password,string $charset,string $appname,bool $new){}
/** @return bool */
...
/** @return bool */
function sybase_set_message_handler(callable $handler,resource $link_identifier){}
/** @return resource */
function sybase_unbuffered_query(string $query,resource $link_identifier,bool $store_result){}
/** @return bool */
...
/** @return bool */
function taint(string &$string,string $__args__){}
/** @return float */
function tan(float $arg){}
/** @return float */
function tanh(float $arg){}
/** @return bool */
function tcpwrap_check(string $daemon,string $address,string $user,bool $nodns){}
/** @return string */
...
/** @return bool */
function tidy_setopt(string $option,mixed $value){}
/** @return int */
...
/** @return string */
function timezone_name_from_abbr(string $abbr,int $gmtOffset,int $isdst){}
/** @return string */
...
/** @return bool */
function touch(string $filename,int $time,int $atime){}
/** @return array */
...
/** @return array */
function trader_adosc(array $high,array $low,array $close,array $volume,integer $fastPeriod,integer $slowPeriod){}
/** @return array */
function trader_adx(array $high,array $low,array $close,integer $timePeriod){}
/** @return array */
function trader_adxr(array $high,array $low,array $close,integer $timePeriod){}
/** @return array */
function trader_apo(array $real,integer $fastPeriod,integer $slowPeriod,integer $mAType){}
/** @return array */
function trader_aroon(array $high,array $low,integer $timePeriod){}
/** @return array */
function trader_aroonosc(array $high,array $low,integer $timePeriod){}
/** @return array */
function trader_asin(array $real){}
/** @return array */
function trader_atan(array $real){}
/** @return array */
function trader_atr(array $high,array $low,array $close,integer $timePeriod){}
/** @return array */
function trader_avgprice(array $open,array $high,array $low,array $close){}
/** @return array */
function trader_bbands(array $real,integer $timePeriod,float $nbDevUp,float $nbDevDn,integer $mAType){}
/** @return array */
function trader_beta(array $real0,array $real1,integer $timePeriod){}
/** @return array */
function trader_bop(array $open,array $high,array $low,array $close){}
/** @return array */
function trader_cci(array $high,array $low,array $close,integer $timePeriod){}
/** @return array */
...
/** @return array */
function trader_cdlabandonedbaby(array $open,array $high,array $low,array $close,float $penetration){}
/** @return array */
...
/** @return array */
function trader_cdldarkcloudcover(array $open,array $high,array $low,array $close,float $penetration){}
/** @return array */
...
/** @return array */
function trader_cdleveningdojistar(array $open,array $high,array $low,array $close,float $penetration){}
/** @return array */
function trader_cdleveningstar(array $open,array $high,array $low,array $close,float $penetration){}
/** @return array */
...
/** @return array */
function trader_cdlmathold(array $open,array $high,array $low,array $close,float $penetration){}
/** @return array */
function trader_cdlmorningdojistar(array $open,array $high,array $low,array $close,float $penetration){}
/** @return array */
function trader_cdlmorningstar(array $open,array $high,array $low,array $close,float $penetration){}
/** @return array */
...
/** @return array */
function trader_cmo(array $real,integer $timePeriod){}
/** @return array */
function trader_correl(array $real0,array $real1,integer $timePeriod){}
/** @return array */
function trader_cos(array $real){}
/** @return array */
function trader_cosh(array $real){}
/** @return array */
function trader_dema(array $real,integer $timePeriod){}
/** @return array */
function trader_div(array $real0,array $real1){}
/** @return array */
function trader_dx(array $high,array $low,array $close,integer $timePeriod){}
/** @return array */
function trader_ema(array $real,integer $timePeriod){}
/** @return integer */
...
/** @return integer */
function trader_get_unstable_period(integer $functionId){}
/** @return array */
...
/** @return array */
function trader_kama(array $real,integer $timePeriod){}
/** @return array */
function trader_linearreg_angle(array $real,integer $timePeriod){}
/** @return array */
function trader_linearreg(array $real,integer $timePeriod){}
/** @return array */
function trader_linearreg_intercept(array $real,integer $timePeriod){}
/** @return array */
function trader_linearreg_slope(array $real,integer $timePeriod){}
/** @return array */
function trader_ln(array $real){}
/** @return array */
function trader_log10(array $real){}
/** @return array */
function trader_ma(array $real,integer $timePeriod,integer $mAType){}
/** @return array */
function trader_macd(array $real,integer $fastPeriod,integer $slowPeriod,integer $signalPeriod){}
/** @return array */
function trader_macdext(array $real,integer $fastPeriod,integer $fastMAType,integer $slowPeriod,integer $slowMAType,integer $signalPeriod,integer $signalMAType){}
/** @return array */
function trader_macdfix(array $real,integer $signalPeriod){}
/** @return array */
function trader_mama(array $real,float $fastLimit,float $slowLimit){}
/** @return array */
function trader_mavp(array $real,array $periods,integer $minPeriod,integer $maxPeriod,integer $mAType){}
/** @return array */
function trader_max(array $real,integer $timePeriod){}
/** @return array */
function trader_maxindex(array $real,integer $timePeriod){}
/** @return array */
function trader_medprice(array $high,array $low){}
/** @return array */
function trader_mfi(array $high,array $low,array $close,array $volume,integer $timePeriod){}
/** @return array */
function trader_midpoint(array $real,integer $timePeriod){}
/** @return array */
function trader_midprice(array $high,array $low,integer $timePeriod){}
/** @return array */
function trader_min(array $real,integer $timePeriod){}
/** @return array */
function trader_minindex(array $real,integer $timePeriod){}
/** @return array */
function trader_minmax(array $real,integer $timePeriod){}
/** @return array */
function trader_minmaxindex(array $real,integer $timePeriod){}
/** @return array */
function trader_minus_di(array $high,array $low,array $close,integer $timePeriod){}
/** @return array */
function trader_minus_dm(array $high,array $low,integer $timePeriod){}
/** @return array */
function trader_mom(array $real,integer $timePeriod){}
/** @return array */
function trader_mult(array $real0,array $real1){}
/** @return array */
function trader_natr(array $high,array $low,array $close,integer $timePeriod){}
/** @return array */
function trader_obv(array $real,array $volume){}
/** @return array */
function trader_plus_di(array $high,array $low,array $close,integer $timePeriod){}
/** @return array */
function trader_plus_dm(array $high,array $low,integer $timePeriod){}
/** @return array */
function trader_ppo(array $real,integer $fastPeriod,integer $slowPeriod,integer $mAType){}
/** @return array */
function trader_roc(array $real,integer $timePeriod){}
/** @return array */
function trader_rocp(array $real,integer $timePeriod){}
/** @return array */
function trader_rocr100(array $real,integer $timePeriod){}
/** @return array */
function trader_rocr(array $real,integer $timePeriod){}
/** @return array */
function trader_rsi(array $real,integer $timePeriod){}
/** @return array */
function trader_sar(array $high,array $low,float $acceleration,float $maximum){}
/** @return array */
function trader_sarext(array $high,array $low,float $startValue,float $offsetOnReverse,float $accelerationInitLong,float $accelerationLong,float $accelerationMaxLong,float $accelerationInitShort,float $accelerationShort,float $accelerationMaxShort){}
/** @return void */
...
/** @return array */
function trader_sma(array $real,integer $timePeriod){}
/** @return array */
function trader_sqrt(array $real){}
/** @return array */
function trader_stddev(array $real,integer $timePeriod,float $nbDev){}
/** @return array */
function trader_stoch(array $high,array $low,array $close,integer $fastK_Period,integer $slowK_Period,integer $slowK_MAType,integer $slowD_Period,integer $slowD_MAType){}
/** @return array */
function trader_stochf(array $high,array $low,array $close,integer $fastK_Period,integer $fastD_Period,integer $fastD_MAType){}
/** @return array */
function trader_stochrsi(array $real,integer $timePeriod,integer $fastK_Period,integer $fastD_Period,integer $fastD_MAType){}
/** @return array */
function trader_sub(array $real0,array $real1){}
/** @return array */
function trader_sum(array $real,integer $timePeriod){}
/** @return array */
function trader_t3(array $real,integer $timePeriod,float $vFactor){}
/** @return array */
function trader_tan(array $real){}
/** @return array */
function trader_tanh(array $real){}
/** @return array */
function trader_tema(array $real,integer $timePeriod){}
/** @return array */
function trader_trange(array $high,array $low,array $close){}
/** @return array */
function trader_trima(array $real,integer $timePeriod){}
/** @return array */
function trader_trix(array $real,integer $timePeriod){}
/** @return array */
function trader_tsf(array $real,integer $timePeriod){}
/** @return array */
function trader_typprice(array $high,array $low,array $close){}
/** @return array */
function trader_ultosc(array $high,array $low,array $close,integer $timePeriod1,integer $timePeriod2,integer $timePeriod3){}
/** @return array */
function trader_var(array $real,integer $timePeriod,float $nbDev){}
/** @return array */
function trader_wclprice(array $high,array $low,array $close){}
/** @return array */
function trader_willr(array $high,array $low,array $close,integer $timePeriod){}
/** @return array */
function trader_wma(array $real,integer $timePeriod){}
/** @return bool */
...
/** @return int */
function udm_hash32(resource $agent,string $str){}
/** @return bool */
...
/** @return string */
function uniqid(string $prefix,bool $more_entropy){}
/** @return int */
function unixtojd(int $timestamp){}
/** @return bool */
function unlink(string $filename,resource $context){}
/** @return array */
...
/** @return void */
//function unset(mixed $var,mixed $__args__){}
/** @return bool */
function untaint(string &$string,string $__args__){}
/** @return void */
function uopz_backup(string $class,string $function){}
/** @return void */
function uopz_compose(string $name,array $classes,array $methods,array $properties,int $flags){}
/** @return Closure */
function uopz_copy(string $class,string $function){}
/** @return void */
function uopz_delete(string $class,string $function){}
/** @return void */
function uopz_extend(string $class,string $parent){}
/** @return int */
function uopz_flags(string $class,string $function,int $flags){}
/** @return void */
function uopz_function(string $class,string $function,Closure $handler,int $modifiers){}
/** @return void */
...
/** @return bool */
function use_soap_error_handler(bool $handler){}
/** @return void */
...
/** @return void */
function var_dump(mixed $expression,mixed $__args__){}
/** @return mixed */
function var_export(mixed $expression,bool $return){}
/** @return mixed */
function variant_abs(mixed $val){}
/** @return mixed */
...
/** @return int */
function variant_cmp(mixed $left,mixed $right,int $lcid,int $flags){}
/** @return variant */
...
/** @return mixed */
function variant_fix(mixed $variant){}
/** @return int */
...
/** @return int */
function vfprintf(resource $handle,string $format,array $args){}
/** @return bool */
...
/** @return bool */
function vpopmail_passwd(string $user,string $domain,string $password,bool $apop){}
/** @return bool */
...
/** @return bool */
function wddx_add_vars(resource $packet_id,mixed $var_name,mixed $__args__){}
/** @return mixed */
...
/** @return string */
function wddx_serialize_vars(mixed $var_name,mixed $__args__){}
/** @return int */
...
/** @return array */
function win32_ps_stat_proc(int $pid){}
/** @return mixed */
function win32_query_service_status(string $servicename,string $machine){}
/** @return bool */
function win32_set_service_status(int $status,int $checkpoint){}
/** @return mixed */
...
/** @return array */
function wincache_fcache_fileinfo(bool $summaryonly){}
/** @return array */
function wincache_fcache_meminfo(){}
/** @return bool */
function wincache_lock(string $key,bool $isglobal){}
/** @return array */
function wincache_ocache_fileinfo(bool $summaryonly){}
/** @return array */
function wincache_ocache_meminfo(){}
/** @return bool */
function wincache_refresh_if_changed(array $files){}
/** @return array */
function wincache_rplist_fileinfo(bool $summaryonly){}
/** @return array */
function wincache_rplist_meminfo(){}
/** @return array */
function wincache_scache_info(bool $summaryonly){}
/** @return array */
function wincache_scache_meminfo(){}
/** @return bool */
function wincache_ucache_add(string $key,mixed $value,int $ttl){}
/** @return bool */
function wincache_ucache_cas(string $key,int $old_value,int $new_value){}
/** @return bool */
function wincache_ucache_clear(){}
/** @return mixed */
function wincache_ucache_dec(string $key,int $dec_by,bool &$success){}
/** @return bool */
...
/** @return mixed */
function wincache_ucache_inc(string $key,int $inc_by,bool &$success){}
/** @return array */
function wincache_ucache_info(bool $summaryonly,string $key){}
/** @return array */
function wincache_ucache_meminfo(){}
/** @return bool */
function wincache_ucache_set(mixed $key,mixed $value,int $ttl){}
/** @return bool */
function wincache_unlock(string $key){}
/** @return string */
function wordwrap(string $str,int $width,string $break,bool $cut){}
/** @return string */
function xattr_get(string $filename,string $name,int $flags){}
/** @return array */
function xattr_list(string $filename,int $flags){}
/** @return bool */
function xattr_remove(string $filename,string $name,int $flags){}
/** @return bool */
function xattr_set(string $filename,string $name,string $value,int $flags){}
/** @return bool */
function xattr_supported(string $filename,int $flags){}
/** @return bool */
...
/** @return bool */
function xdiff_file_diff(string $old_file,string $new_file,string $dest,int $context,bool $minimal){}
/** @return mixed */
...
/** @return mixed */
function xdiff_file_patch(string $file,string $patch,string $dest,int $flags){}
/** @return bool */
...
/** @return string */
function xdiff_string_diff(string $old_data,string $new_data,int $context,bool $minimal){}
/** @return mixed */
...
/** @return void */
function xhprof_enable(int $flags,array $options){}
/** @return array */
...
/** @return resource */
function xml_parser_create_ns(string $encoding,string $sep){}
/** @return resource */
...
/** @return string */
function xmlrpc_encode_request(string $method,mixed $params,array $output_options){}
/** @return string */
...
/** @return bool */
function xml_set_character_data_handler(resource $parser,callable $handler){}
/** @return bool */
function xml_set_default_handler(resource $parser,callable $handler){}
/** @return bool */
function xml_set_element_handler(resource $parser,callable $start_element_handler,callable $end_element_handler){}
/** @return bool */
function xml_set_end_namespace_decl_handler(resource $parser,callable $handler){}
/** @return bool */
function xml_set_external_entity_ref_handler(resource $parser,callable $handler){}
/** @return bool */
function xml_set_notation_decl_handler(resource $parser,callable $handler){}
/** @return pool */
function xml_set_object(resource $parser,object &$object){}
/** @return bool */
function xml_set_processing_instruction_handler(resource $parser,callable $handler){}
/** @return bool */
function xml_set_start_namespace_decl_handler(resource $parser,callable $handler){}
/** @return bool */
function xml_set_unparsed_entity_decl_handler(resource $parser,callable $handler){}
/** @return bool */
function yaml_emit_file(string $filename,mixed $data,int $encoding,int $linebreak,array $callbacks){}
/** @return string */
function yaml_emit(mixed $data,int $encoding,int $linebreak,array $callbacks){}
/** @return mixed */
function yaml_parse_file(string $filename,int $pos,int &$ndocs,array $callbacks){}
/** @return mixed */
function yaml_parse(string $input,int $pos,int &$ndocs,array $callbacks){}
/** @return mixed */
function yaml_parse_url(string $url,int $pos,int &$ndocs,array $callbacks){}
/** @return string */
...
function yp_errno(){}
/** @return string */
function yp_err_string(int $errorcode){}
/** @return array */
...
/** @return string */
function zlib_decode(string $data,string $max_decoded_len){}
/** @return string */
