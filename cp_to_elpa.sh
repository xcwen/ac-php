...
cp -rf ac-php-core.el phpctags ac-php-comm-tags-data.json ~/.emacs.d/elpa/ac-php-core-20*/
...
cp -rf ac-php-core.el phpctags ac-php-comm-tags-data.json ~/.emacs.d/elpa/develop/ac-php-core-20*/
